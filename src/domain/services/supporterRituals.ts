...
const RITUALS: Record<RitualMoment, string[]> = {
  ...
  corner: [
    ...
    'Trumman slår takt. Hörnans melodi fyller vallen.',
    '{family} sjunger med barnen. De kan varje ord.',
  ],
  suspension: [
    'Utvisningssången. {leader} leder, {group} följer.',
    '"Skääms — skääms!" Stämman i {group} är samlad.',
  ...
  fullTimeWin: [
    ...
    '{youth} springer ner till sargen. Hon vill hinna säga någonting till {player}.',
    '{group} sjunger segersången tills de sista åskådarna lämnat.',
    '{family} bär hem barnen på axlarna. Det är sena kvällar de minns.',
    '{veteran} säger till {leader}: "Det här håller." {leader} håller med.',
  ],
  fullTimeLoss: [
    '{group} stannar. Det är tyst en stund. Sedan klappar de.',
    ...
    '{family} tar barnen i handen. "Vi vann förra veckan", säger han.',
  ],
  awayTrip: [
