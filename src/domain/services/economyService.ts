...
// ── Legacy display helper (kept for reference, use calcRoundIncome instead) ───
...
/** @deprecated Use calcRoundIncome — this function has diverged from the actual mutation logic */
