...
export const ROLLOVER_POLICY_BY_TYPE: Record<GameEventType, RolloverPolicy> = {
  ...
  // DOM_BURNOUT_TAK_2026-09-02, MUST-TIER-BESLUT (Jacob 2026-09-02): tier är
  // nu 'must' (decisionTierService.ts) — samma "kan aldrig deferreras"-status
  // som contractRequest/licenseHandlingsplan ovan. expire = tyst noOp om det
  // ändå händer, aldrig ett gissat val.
