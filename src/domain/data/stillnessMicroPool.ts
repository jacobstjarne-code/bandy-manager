...
export const STILLNESS_MICRO: StillnessMicro[] = [
  ...
  { body: 'Lokaltidningen skrev en helsida om ny asfalt vid hallen. Sportsidan fick en notis.', icon: '📰' },
  ...
  { body: 'Kyrkklockorna hörs ända in i hallen om dörren står öppen. Någon stänger den alltid lagom till nedsläpp.', icon: '🔔', proximity: 'eve' },
