...
export const BOARD_MEETING_COPY: Record<BoardMeetingState, StatePool> = {
  A: {
    settings: [
      ...
      'Klubbstugan, andra våningen. Genom fönstret syns planen, helt tom.',
  ...
  B: {
    ...
    speakerLines: [
      ...
      'Vi gjorde det mesta av det vi sa. Nu är frågan: vad nu?',
