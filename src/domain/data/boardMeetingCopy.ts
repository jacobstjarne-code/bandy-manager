...
export const BOARD_MEETING_COPY: Record<BoardMeetingState, StatePool> = {
  ...
  B: {
    ...
    speakerLines: [
      'Fjolåret sitter i. Men vi ska inte bli mätta. Ett år till på den nivån — då pratar vi om något.',
      ...
      'Yngste i truppen var bättre än vi trodde. Matchvinnare i fem år till, om vi behåller honom.',
  ...
  C: {
    settings: [
      ...
      'Vallen, sittande på läktaren. Ordföranden ville se isen medan de pratade.',
