...
// Partial, inte Record: den generiska `decision`-triggern saknar medvetet en
// egen klausul. Beslutets identitet ligger i eventLedger.semanticKey och den
// här beat-ytan visar bara systemkedjorna nedan.
