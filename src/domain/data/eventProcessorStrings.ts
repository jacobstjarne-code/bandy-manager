...
export const RISKY_SPONSOR_OFFERS = [
  {
    ...
    weeklyIncome: 550,
    title: 'Borgvik Bygg AB erbjuder marknadsavtal — 550 kr/omgång',
    body: 'Borgvik Bygg AB erbjuder marknadsavtal med {KLUBB}: 550 kronor per omgång i 44 omgångar. VD:n nämner i samtal att företaget "går igenom en granskning från Skatteverket men det är rutin". Avtalet är klart att skriva på.',
    acceptLabel: 'Acceptera (550 kr/omgång)',
  ...
  },
  {
    ...
    weeklyIncome: 365,
    title: 'Nordström Logistik AB vill bli sponsor — 365 kr/omgång',
    body: 'Nordström Logistik AB hör av sig genom sin nytillträdde VD och erbjuder 365 kronor per omgång i 44 omgångar. Företaget är okänt på orten men har god kontakt med tre andra klubbar i regionen. VD:n vill träffas snart. Hans bakgrund finns inte på företagets hemsida ännu.',
    acceptLabel: 'Acceptera (365 kr/omgång)',
  ...
  },
  {
    ...
    category: 'Konsult',
    weeklyIncome: 680,
    title: 'Hellström & Co — kontakt via gemensam vän — 680 kr/omgång',
    body: '"Vi har gemensamma bekanta", står det i mejlet från Hellström & Co. Företaget vill betala 680 kronor per omgång i 44 omgångar. När du frågar vilka bekanta blir svaret "det är en småstad". Det stämmer, men du har ingen aning om vem de menar.',
    acceptLabel: 'Acceptera (680 kr/omgång)',
  ...
  },
  {
    ...
    category: 'Holding',
    weeklyIncome: 910,
    title: 'Lindström Holdings: 910 kr/omgång — direkt avtal',
    body: 'Lindström Holdings erbjuder 910 kronor per omgång i 44 omgångar. "Inga byråkratiska processer", skriver han, "vi vill bara stötta lokal idrott". Ersättningen är osedvanligt hög. Bolaget registrerades för fyra månader sedan.',
    acceptLabel: 'Acceptera (910 kr/omgång)',
