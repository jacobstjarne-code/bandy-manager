...
export const BOARD_QUOTES: Record<BoardPersonality, string[]> = {
  supporter: [
    ...
    '"Stämningen på läktaren var magisk i helgen."',
    ...
    '"Sälj mer i kiosken! Folk vill ha korv och kaffe."',
  ...
  traditionalist: [
    '"Det pratas för mycket och tränas för lite nuförtiden."',
    '"Förr utvecklade vi egna spelare."',
    '"Man ska inte krångla till det. Bandy är ett enkelt spel."',
    ...
    '"Vi ska inte försöka vara något storlag. Vi ska vara oss själva."',
    ...
    '"Köpa spelare? Förr fostrade vi dem själva."',
  ],
  modernist: [
    '"Vi behöver tänka nytt. Sociala medier, sponsorpaket."',
    '"Har ni sett vad andra klubbar gör med sin marknadsföring?"',
    '"Vi borde streama alla matcher. Folk tittar i mobilen numera."',
    ...
    '"Jag läste att storklubbarna har hela analysstaber. Vi har noll."',
...
export const BOARD_CONTEXT_QUOTES: Record<BoardPersonality, Record<string, string[]>> = {
  ...
  ekonom: {
    ...
    fewSponsors: [
      ...
      '"Jag hörde att grannklubbarna får in nya sponsorer. Vad gör vi?"',
    ],
    lastSeasonGood: [
...
export const BOARD_MEETING_OPENERS = [
  ...
  '{ordförande}: "Kort möte idag, jag har lovat att vara hemma tidigt."',
