 ...
 * (docs/archive/historiska-statuskallor/SLUTTEST_KO.md rad 58, contentContract.ts): "Skydd eller illusion?"
 ...
 * rutter täcks; höj den ALDRIG utan en rad i docs/archive/historiska-statuskallor/BACKLOG.md om varför.
 */
...
// Höjd 7 → 8 (2026-08-28, A-H2b docs/dom/DOM_AH2B_RETENTION_2026-08-28.md): ny rutt
...
// Se docs/archive/historiska-statuskallor/BACKLOG.md ("BYGGT MEN OSYNLIGT/ONÅBART") för stäng-villkoret.
// Höjd 8 → 9 (2026-08-29, O13 docs/dom/DOM_TRANARMARKNADEN_2026-08-26.md): ny rutt
...
// ägare i docs/archive/historiska-statuskallor/BACKLOG.md ("BYGGT MEN OSYNLIGT/ONÅBART").
