...
export function optionTitle(o: FinancingOption): string {
...
export function optionSub(o: FinancingOption): string {
...
/**
 * design-d7-bottennav-sju (DOM 2026-09-03, Jacob) — Bygget bytte hem från en
 * egen bottennav-flik till en flik under Klubb. Innehållet (träd + sheets)
 * flyttat hit ordagrant ur FacilityScreen.tsx, som nu bara är ett tunt skal
 * för push-baserade djuplänkar (Portal-kortet "bygge klart", Ortskartans
 * arena-nod, hallprövningens tillbaka-pil) och renderar denna komponent.
 */
export function FacilityTab({ game, navigate, startFacilityBuildNode, decommissionFacilityNode }: FacilityTabProps) {
