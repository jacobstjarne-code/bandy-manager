...
export default defineConfig({
  build: {
    rollupOptions: {
      output: {
        // Ramverket ändras betydligt mer sällan än spelkoden och ska inte
        // räknas in i den produktägda huvudchunken. Det ger dessutom en
        // stabil cachegräns över spelreleaser.
        manualChunks(id) {
