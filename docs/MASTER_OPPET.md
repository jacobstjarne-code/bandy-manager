...
|---|---|---|---|---|---|
| grind2-nykarriar-kompletterande-aterprov | Separat nykarriärprov behöver sammanhängande återprov efter derbyfixen | rapporterad | Codex/Astra | docs/playtest/GRIND2_DUBBELSPAR_ASTRA_F993DDD2_2026-09-11.md | De fyra nådda releaseblockerarna från provet mot `f993ddd2` är rotfixade i `593fa055`: anslagsdismiss, klubbägarskap för spelarevent, årsbokens gemensamma sanning/ny objektivprogress och atomär transferbudsdedupe. Kör nu ett nytt obrutet naturligt tvåsäsongsprov på medel mot denna pinne. Grind 2 arkiveras först när både invariantspåret och spelkänslan passerar utan kärnflödesstopp eller lögn i nådd scen. |
...
| inv-5-fas4-klubbmarken | FAS 4 (12 klubbmärken) bara 3/12 klara | verifierad | Jacob | INVENTERING_2026-08-31.md:114 | **FORSBACKA-PILOT godkänd och komplett, väntar start av nästa klubb (Codex 2026-09-11):** den högupplösta källan är bevarad och rutbakgrunden frilagd till äkta alfa. Två självständiga produkt-SVG:er (32/64 px, 3× inbäddad rastertäthet) är wirade genom befintliga `ClubBadge`; ≤40 px väljer kompakt och större ytor full variant, övriga elva klubbar behåller legacy-fallback tills deras tur. Verifierat: 3 fokustester, full build, headerprov 56/40 px samt riktig `NextMatchPrimary`-matchpresentation Forsbacka–Heros i browser; ingen rutbakgrund, trasig asset eller fallback. Devvyn `next-match-forsbacka` ligger kvar för sekvensjämförelse. Aktivräknaren oförändrad. |
