...
| id | beskrivning | status | ägare | källa | nästa-åtgärd |
|---|---|---|---|---|---|
| c-sp5-smfinal-skarv | SM-final-uppspelets skarv: svart panel på grå bakgrund ger hårt skarvband | in_progress | Codex | BACKLOG.md:599 | CLAIM 2026-09-10T13:30:00+02:00 — Codex. Återverifiera raden mot de senare uttryckliga C-SP5-committarna (`c965becf`, `837480e6`, `b6f89c88`) och dagens `FinalIntroScreen`/matchskal; avför bara om hela svart/grå-skarven faktiskt täcks, annars fixa det kvarvarande konkreta lagret. [Verifierat 2026-09-01 (Code): MASTER_OPPET.md:305 bekräftar explicit att BACKLOG:599s C-SP5 (uppspelets skarv) är "ANNAN, fortfarande öppen sak" skild från den redan levererade crossfade-fixen (`0e39f24`).] |
