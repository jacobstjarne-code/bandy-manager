...
|---|---|---|---|---|---|
| bandygala-dubblett-samma-sasong | Exakt samma \`Bandygalan 2031\` med samma fem pristagare visades och hanterades i både omgång 2 och omgång 6 under säsong 2031/32. | in_progress | Code | Grind 2, 2031/32 omg 2 + 6, 2026-09-10 | CLAIM 2026-09-10T23:21:51+02:00 — Code. Stabilt event-id, men \`resolveEvent\` pensionerar i domänen bara \`pendingEvents\`-kopian; \`deferredDecisions\` rensas indirekt av vissa store-anropares efterföljande promotion. Flytta båda köernas pensionering till resolutionskontraktet och lås med gala-regression. Ingen copyfix. |
