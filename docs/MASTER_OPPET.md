...
| inv-5-fas4-klubbmarken | FAS 4 (12 klubbmärken) bara 3/12 klara | verifierad | Jacob | INVENTERING_2026-08-31.md:114 | **FORSBACKA-PILOT klar, väntar visuellt godkännande (Codex 2026-09-11):** den högupplösta källan är bevarad och rutbakgrunden frilagd till äkta alfa. Två självständiga produkt-SVG:er (32/64 px, 3× inbäddad rastertäthet) är wirade genom befintliga `ClubBadge`; ≤40 px väljer kompakt och större ytor full variant, övriga elva klubbar behåller legacy-fallback tills deras tur. Ny devvy visar samma märke i verkliga `MiljoHeader`-lägen 56/40 px. Verifierat: 3 fokustester gröna, full `npm run build` grön, browserkontroll i `miljoheader-forsbacka` utan rutbakgrund eller trasig asset. Aktivräknaren oförändrad; nästa sekvensstart kräver Jacobs visuella ja. |
