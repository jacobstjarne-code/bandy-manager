...
|---|---|---|---|---|---|
| arsbok-omgangsetikett-blandform | Årsbokens tidslinje blandar interna etiketter som `O3`/`O14` med spelartexten `Omg 1`/`Omg 2`, vilket får markörerna att hoppa visuellt och läsa som två system | rapporterad | Code | Jacobs browserfynd 2026-09-11, riktig årsbok 2036/37 | Kod- och gitverifiera om blandningen kommer från fryst `roundLabel` kontra fallback; beslutad målyta är konsekvent `Omg N` för ligahändelser utan att skriva om sparad kanon. Aktiv räknare 6→7. |
