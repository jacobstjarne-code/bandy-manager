...
|---|---|---|---|---|---|
| season-end-gemini-watermark | Säsongsslutsbilden med bandybollen visar en Gemini-vattenstämpel nere till höger | in_progress | Code | Jacob 2026-09-10 + `public/assets/illustrations/season-end.jpg` | CLAIM 2026-09-10T23:33:51+02:00 — Code. Visuellt verifierad mot den faktiska produktfilen och git `f183ba8a`: vit Gemini-symbol i nederkant. Ta bort endast märket, bevara bildens komposition och verifiera produktasset + säsongsslutsscen. Aktiv räknare 7→8 tills passet arkiveras. |
