...
| pt6-nedslackning-timing | Matchens blockinteraktioner saknar den ratificerade nedsläckningen: resultattavlan ska stå kvar fullt belyst medan underlaget faller till 34 % ljus/70 % mättnad och scenen stiger in med låst timing. | in_progress | Codex | `DOM_POLISH_NEDSLACKNING_2026-09-10.md` | CLAIM 2026-09-10T13:42:43+02:00 — Codex. Återöppnad efter att den äldre, vagare PT-6-noten arkiverats som stale; den nya domen är en uttrycklig byggorder. Implementera `.match-dimmed` för blockinteraktioner, scrim från den faktiska scoreboard-höjden (ingen hårdkodad 54 px), låsta in-/ut-tider och reduced-motion; verifiera visuellt utan ny baseline. |
