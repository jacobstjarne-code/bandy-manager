...
| inv-5-fas4-klubbmarken | FAS 4 (12 klubbmärken) bara 3/12 klara | in_progress | Codex · 2026-09-11T17:04:59+0200 | INVENTERING_2026-08-31.md:114 | **FORSBACKA-PILOT godkänd av Jacob 2026-09-11; matchpresentationsprov pågår:** den högupplösta källan är bevarad och rutbakgrunden frilagd till äkta alfa. Två självständiga produkt-SVG:er (32/64 px, 3× inbäddad rastertäthet) är wirade genom befintliga `ClubBadge`; ≤40 px väljer kompakt och större ytor full variant, övriga elva klubbar behåller legacy-fallback tills deras tur. Headerprovet är grönt (3 fokustester + full build + browser). Codex seedar nu Forsbacka i den befintliga riktiga matchpresentationen och browserverifierar den före sekvensstart för nästa klubb. Aktivräknaren oförändrad. |
