...
| grind2-arsbok-styrelsekrav-motsags | Årsboken beskriver 9:e/8:e plats som uppfyllt eller överträffat krav trots portalens och inkorgens mål Sluta topp 6 | in_progress | Codex/Astra | playtest/GRIND2_DUBBELSPAR_ASTRA_2026-09-11.md | CLAIM 2026-09-11T12:20:47+02:00 — Codex/Astra. Verifierat 2026-09-11 genom kodläsning mot `d36afeec`: årsbokens huvuddom läser `seasonStartBoardExpectation`, medan det säsongsbundna `topHalf`-kravets faktiska resolution bara reduceras till en anonym räknare i `objectiveOutcome`; 8:e/9:e plats kan därför samtidigt beskrivas som godkänd och vara explicit misslyckad i portal/inkorg. Koppla årsboksdomen till den frusna sportsliga objektivresolutionen utan ny tröskel. Identitetsdedupe för samma derbytriumf finns redan i `mergeYearbookTimelineItems`; återprova den riktat i samma pass. |
