...
|---|---|---|---|---|---|
| arsbok-omgangsetikett-blandform | Årsbokens tidslinje blandar interna etiketter som `O3`/`O14` med spelartexten `Omg 1`/`Omg 2`, vilket får markörerna att hoppa visuellt och läsa som två system | verifierad | Code | Jacobs browserfynd 2026-09-11, riktig årsbok 2036/37 | Kodverifierat 2026-09-11: fixture-keyMoments bär tävlingssann `roundLabel` (`Omg N` för liga), medan storyline-projektionen bara bär global `matchday` och UI:t fabricerar `O${round}`. En blind `Omg`-normalisering skulle felmärka exempelvis en storyline på matchdag 3 som ligaomgång 3 fast den underliggande matchen var omgång 1. Bygg fast pillbredd, `Omg N` för belagd ligaomgång och `Dag N` för sann matchdagsfallback; ingen save-migration.
