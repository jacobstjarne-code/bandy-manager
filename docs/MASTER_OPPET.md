...
| genomgang-motor-utvisning-halvlek | Utvisningstimers seedas aldrig över halvleks-/regen-gränsen: en utvisning aktiv vid halvtid varar hela 2H + förlängning (0.65/1.20-faktorerna i 30 steg i stället för ≤7). Träffar grovt 35–40 % av matcherna, inbakat i kalibreringen | rapporterad | Code | §12 | Timers i MatchStep + SecondHalfInput, fem anropsställen, regressionstest, stresstest före/efter. Glid >0,15 mål/match → rapportera till Opus, rör inte GOAL_RATE_MOD. |
