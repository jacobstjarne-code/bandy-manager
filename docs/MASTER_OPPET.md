...
| grind2-kafferum-fatiguepool-cooldown | Generella fatigue-repliker i kafferummet återkommer inom samma säsong trots kravet på två säsongers cooldown | in_progress | Codex/Astra | playtest/GRIND2_DUBBELSPAR_ASTRA_2026-09-11.md | VERIFIERAD 2026-09-11: fatigue väljer deterministiskt ur åtta rader utan att läsa `narrativeBeatLog`, och avslutet skriver deras index som generiska `coffee_pool_*`; victory-ekot har korrekt cooldownfunktion men rendergrenen anropar den inte. CLAIM 2026-09-11T13:18:00+02:00: bär stabil radidentitet från selektion till kvitto, grinda båda grenarna mot två säsonger och ge hot-läget större variation med befintlig Opus-text utan att ändra frekvensgaten. |
| arrival-topnav-kontrast-mobil | Ankomstens genreetikett, progress-streck och Hoppa över-länk försvinner mot den ljusa himlen i klubbarnas mobilbilder | in_progress | Codex/Astra | Jacobs mobilgranskning 2026-09-11 | VERIFIERAD 2026-09-11: `ArrivalScene` lägger toppkontrollerna direkt över fullbleed-bilden; `.arrival-scrim` saknar backing, genreetiketten har 70 procents opacitet och skip-länken använder den ljusa dark-scene-tokenen. CLAIM 2026-09-11T13:31:00+02:00: ge enbart Ankomsten mörk varm topphierarki och en diskret bildoberoende halo/backing, utan att påverka övriga scener eller parallella galaändringar. |
