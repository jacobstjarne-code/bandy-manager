...
| c-sp5-smfinal-skarv | Portalens SM-finalkort och finaluppspelet saknar den dömda gold-överlämningen; de är fortfarande två separata ytor med ett hårt snitt. | in_progress | Codex | DOM_POLISH_SMFINAL_SKARV_2026-09-10.md | CLAIM 2026-09-10T14:22:24+02:00 — Codex. Återöppnad efter att den tidigare stale-bedömningen rättats genom kodläsning. Bygg återanvändbar SceneSeam, men wira i detta pass endast SM-finalens portal-CTA → uppspel. Bevara exakt en gold-fylld yta genom hela övergången, tier-stöd och reduced-motion; ingen baseline. |
