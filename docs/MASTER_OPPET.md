...
|---|---|---|---|---|---|
| portal-scrollindikator-saknas | I innehållsrika Portal-lägen fortsätter kort och ibland svarsalternativ bakom den fasta CTA-stacken utan en tydlig signal om att mer finns nedanför. | rapporterad | Code | `playtest/SCROLLINDIKATOR_SVEP_2026-09-10.md` + Jacobs fråga 2026-09-10 | Verifiera scrollägarskapet mellan `GameShell` och `PortalScreen`; bygg därefter samma villkorade/klickbara indikator som i Granska ovanför hela den uppmätta CTA-stacken, utan global GameShell-pil. |
