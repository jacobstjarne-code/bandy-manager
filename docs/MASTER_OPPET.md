...
| licensavdrag-text-och-rollover | Licensbrevet säger “Tre poäng” och ett nytt avdrag riskerar att aktiveras en säsong för sent | rapporterad | — | Grind 2-skärmbild 2026-09-11 + seasonEndProcessor.ts | Skriv “tre poängs avdrag inför nästa säsong”. Spåra `licensePendingDeductions` genom rollover och bevisa att nästa säsongs tabell — inte säsongen därpå — startar med −3. |
