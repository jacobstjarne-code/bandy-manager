...
| inv-4-o12-forhandsdelta | O12 "förhandsdelta" (DOM_DOMINANS_OCH_FORHANDSDELTAN) skriven men aldrig byggd | in_progress | Codex | INVENTERING_2026-08-31.md:103 + SLUTTEST_KO.md:1060 | CLAIM 2026-09-09 — Codex bygger §2 mot låst dom `DOM_O12_FORHANDSTEXT_KONTRAKT_2026-09-09.md`: `subtitle` blir kvalitativ förhandstext enligt resursvokabulären, exakta icke-pengatal härleds ur applicerad `EventEffect` först efter valet, och `costLabel`/D1 lämnas orörda. Ingen regex eller presentationssanering. §1 KLAR `06336d37`: instanssann telemetri, kvittenser exkluderas och flerstegskedjor bevaras. Fullt browserbelägg: `RAPPORT_O12_VALENTROPI_BROWSER_2026-09-09.md`. Efter §2 återstår deployprov och naturlig population för 80 %-grinden. D1:s ambientväg och O5 finns redan. Dedup 2026-09-03: konsoliderar `sluttest-o12-forhandsdeltan`. |
