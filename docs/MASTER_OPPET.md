...
|---|---|---|---|---|---|
| trott-startelva-raknare-fel-population | Bekräftelserutan säger samtidigt "15 av 11 har minst 22 % kondition" och "Du har inte elva spelare med tillräcklig kondition". | in_progress | Codex | Grind 2, 2030/31 omg 8, 2026-09-10 | CLAIM 2026-09-10T23:15:44+02:00 — Codex. Verifierat i aktuell kod: modalen öppnas på `belowFloorStarters` i den valda elvan men räknar rubriktalet över hela spelartruppen. `shortfall` beskriver samtidigt truppens möjliga pool, så manuell trött uttagning kan ge varning med `shortfall=0`. Bind hela varningen till samma faktiska startelva och testa både tvingad autofyllning och manuellt trött val. |
