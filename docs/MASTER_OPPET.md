...
|---|---|---|---|---|---|
| arsbok-hero-platta-for-opak | Årsbokens resultatyta är för opak mot bakgrundsillustrationen och läser varken som tydlig bild eller avsiktlig glasplatta. | verifierad | Codex | Jacobs browserfeedback 2026-09-11 | Kodkontroll: plattan blandar in 86 % solid `var(--bg)` och döljer därför huvuddelen av motivet; sänk opaciteten och bevara textkontrasten. |
