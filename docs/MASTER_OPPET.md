...
| genomgang-matchprofile-halvlek | Andra halvlek/regenerering rullar ny matchProfile från annan seed — defensive_battle kan bli chaotic i paus, tvärtemot kommentaren i matchCore | rapporterad | Code | §11 | Skicka `matchProfile` från första halvlekens steg som input i stället för att rulla om. Liten diff, motortest. |
