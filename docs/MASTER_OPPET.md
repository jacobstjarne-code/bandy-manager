...
|---|---|---|---|---|---|
| grind2-burnout-aterfall-valtext | Återfallsmarkören antar fel tidigare burnout-val | rapporterad | Codex | playtest/GRIND2_NYKARRIAR_LESJOFORS_2026-09-11.md | Läs faktiskt terminalt val; bevara citatidentiteter och cooldown. |
| grind2-berattelse-matchfakta | Matchtexter, januari och interaktivt hörnmål motsäger fixture/state | rapporterad | Codex | playtest/GRIND2_NYKARRIAR_LESJOFORS_2026-09-11.md | Tävlings-, hemma/borta- och kalenderförankra; granska landslagsfrånvaro och hörnstatistik. Ingen balansändring. |
| grind2-inkorg-aktualitet | KRÄVER SVAR, introgrind och uppskjutna berättelser saknar sann aktualitet | rapporterad | Codex | playtest/GRIND2_NYKARRIAR_LESJOFORS_2026-09-11.md | Skilj upplysning från beslut, följ röst/topic-intro och tidsförankra gammal text. |
| grind2-mecenat-samtalsvag | Portal visar åtta slutkombinationer i stället för befintlig middagsscen; fel namn | rapporterad | Codex | playtest/GRIND2_NYKARRIAR_LESJOFORS_2026-09-11.md | Återanvänd stegdialogen och avlägsna hårdkodad Eklund. Galans gestaltning bedöms separat. |
| grind2-nykarriar-kompletterande-aterprov | Separat nykarriärprov underkändes; exakt supporter-konflikt saknar täckning | rapporterad | Codex | playtest/GRIND2_NYKARRIAR_LESJOFORS_2026-09-11.md | Efter rättning: regressionsprov, checkpoints och styrt nytt tvåsäsongsprov; ingen pass utan faktiskt triggade riskscener. |
