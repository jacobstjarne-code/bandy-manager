...
|---|---|---|---|---|---|
| sasongsmal-barare-raknar-inhopp-och-ny-klubb | Målet `Låt {spelare} bära laget` är dömt som minst 15 starter, men säsongsdomen läser spelarens globala `seasonStats.gamesPlayed`; inhopp och matcher efter försäljning till en annan klubb kan därför ge ett falskt `Du gjorde det`. | rapporterad | Code | DOM_EGET_SASONGSMAL_2026-08-17.md:44 + KARRIARJOURNAL_VASTANFORS_2026-09-09.md:114 | Verifiera mot kod/historik och mät därefter faktiska starter i den managerstyrda klubbens färdigspelade matcher, från fixture-elvorna; bevara sann delprestation före en eventuell försäljning. |
