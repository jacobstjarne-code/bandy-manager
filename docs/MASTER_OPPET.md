...
| id | beskrivning | status | ägare | källa | nästa-åtgärd |
|---|---|---|---|---|---|
| sluttest-grind2 | Grind 2 (andra akten: ekonomiskt val år åtta, ingen upprepad pivotal scen, färdigt anläggningsträd) villkorligt passerad | in_progress | Codex | SLUTTEST_KO.md:376 + TESTINSTRUKTION_GRIND_234_2026-09-08.md + DOM_GRIND_2_3_2026-09-10.md | CLAIM 2026-09-09T08:21:53+02:00 — Codex. Opus dom 2026-09-11: ekonomivalet år 8 och det färdiga anläggningsträdet är bevisade. Villkoret som återstår är ett kort naturligt prov på aktuell main efter portal-/kövågen: cirka 2–3 säsonger som tränar burnout, kafferummets tvåsäsongers-cooldown, galans durabla resolution och deferred-köns dedupe/promotion. Codex felsöker först de fyra kodvägarna efter alternativa producenter, instabil identitet och övergångsglapp; rent återprov arkiverar raden som passerad. |
| sponsor-motbud-kopromotion-saknas | Sponsorers motbudsutfall lämnar uppskjutna beslut i kön trots att en aktiv plats frigjorts | in_progress | Codex | Grind 2-hypotespass 2026-09-11 | CLAIM 2026-09-11T08:41:33+02:00 — Codex. Kod- och historikkontroll: `commitSponsorCounter` infördes i `3dd2503e` och båda terminala grenarna står kvar utanför den promotion som vanliga `resolveEvent`, veckobeslut och marknadsbeslut gör. `walked_away` tar endast bort den synliga posten och `accepted` anropar domänresolvern direkt; ingen gren kör `promoteFromQueue`, och inga store-tester täcker övergången. Med en icke-tom `deferredDecisions` frigörs alltså en plats utan att nästa beslut surfar förrän senare omgångsunderhåll. Bygg gemensam slutstegspromotion för båda utfallen; `stood_firm` ska fortsatt lämna kön orörd eftersom inget beslut avslutats. Aktiv räknare fortsatt 6. |
