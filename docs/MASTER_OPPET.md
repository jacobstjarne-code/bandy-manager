...
| stickiness-permission-ogonblick | Värdebaserad pre-prompt och knapp är kopplade, men skarp backend är avstängd | in_progress | Codex | Rapporten §11, Implementation | CLAIM 2026-09-10T16:01:49+02:00 — Codex. Jacob dömde 2026-09-10: första frågan efter tre egna färdigspelade matcher + läst Granska + verkligt obekräftat lag; ”Inte nu” skjuter upp frågan i stället för att stänga permanent. Bygg timingdelen; kategorier/quiet hours förblir Design-rest. Tidigare implementation frågade efter första matchen och lagrade ”Inte nu” permanent per save. |
