...
| inv-4-o12-forhandsdelta | O12 "förhandsdelta" (DOM_DOMINANS_OCH_FORHANDSDELTAN) skriven men aldrig byggd | in_progress | Codex | INVENTERING_2026-08-31.md:103 + SLUTTEST_KO.md:1060 | CLAIM 2026-09-09T09:19:52+02:00 — Codex. Skapar en ny mobilkarriär i den riktiga browserytan, fattar nya attribuerade spelarval, exporterar saven och kör `analyze:choice-entropy` innan någon O12-kod bedöms. U9-verktyget är byggt 2026-09-02 (`npm run analyze:choice-entropy -- <exporterad-save.json>`), men domen kräver att resultatet RAPPORTERAS före O12-bygge. Äldre poster (`resolvedChoices`) saknar säker attribution och exkluderas medvetet, får inte gissas. D1:s ambientväg och O5 finns redan; ingen separat O12-mekanik ska byggas utan mätbelägg. Dedup 2026-09-03: konsoliderar `sluttest-o12-forhandsdeltan` (samma punkt, två källor). |
...
| sluttest-grind1-heros-ekonomi | Grind 1-sidofynd (b): ekonomimodellen för svaga klubbar (Heros ekonomi), verifierad men obyggd | in_progress | Code | SLUTTEST_KO.md:239, 352, 364 | CLAIM 2026-09-09T09:14:46+02:00 — Code. → MÄT-GEJTAT 2026-09-08 (Jacob): efter att `mecenat-patron-modellform` byggts + ommätts, mät Heros ekonomi specifikt — den cs-skalade patronen/mecenaten kan lyfta den. Bygg en separat svagklubbs-ekonomifix BARA om kurvan fortfarande går back efter det. Stapla inte två fixar blint. Ägare Code (mätning först). [Verifierat 2026-09-01: BACKLOG.md:41-49, Heros går back på upgraded+VIP.] |
...
| sluttest-utvisningar-kalibrering | Värdet har glidit något nedåt, fortfarande en verklig kalibreringsskuld | in_progress | Code | SLUTTEST_KO.md:192 | CLAIM 2026-09-09T09:14:46+02:00 — Code. Regenererad körning (7499 matcher): 2,614 utv/match mot mål 3,77. **→ GO 2026-09-08 (Jacob): kalibrera UPP mot 3,77 — 2,61 är för lågt för bandy. Code justerar konstanten + mäter om. Byggbar.** (Tidigare 2,62-2,67.) |
