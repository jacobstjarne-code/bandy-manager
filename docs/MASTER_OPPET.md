...
|---|---|---|---|---|---|
| scrollindikator-ceremoni-och-krav | Årsboken, finalens startelvor och säsongens lönekrav ska använda samma villkorade scrollindikator när respektive innehåll faktiskt överflödar. | rapporterad | Code | Jacobs beslut 2026-09-10 + `playtest/SCROLLINDIKATOR_SVEP_2026-09-10.md` | Verifiera de tre separata scrollbehållarna och actionytorna. Extrahera Granskas indikator till en gemensam komponent; wira den lokalt i respektive scrollägare, aldrig globalt. |
