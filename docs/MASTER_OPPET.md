...
| arsbok-akademi-singular | Akademiraden skriver “1 stjärnor” | in_progress | Codex | Grind 2-skärmbild 2026-09-11 + academyLedgerPresentationService.ts:133 + clubMemoryService.ts:335 | CLAIM 2026-09-11T09:36:00+02:00 — Codex. Två faktiska textproducenter interpolerar `${stars} stjärnor` utan böjning. Inför en delad svensk stjärnformatering och använd den i båda vägarna; regressionstesta singular och plural. |
