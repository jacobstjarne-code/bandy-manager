...
|---|---|---|---|---|---|
| scrollindikator-ceremoni-och-krav | Årsboken, finalens startelvor och säsongens lönekrav ska använda samma villkorade scrollindikator när respektive innehåll faktiskt överflödar. | in_progress | Codex | Jacobs beslut 2026-09-10 + `playtest/SCROLLINDIKATOR_SVEP_2026-09-10.md` | CLAIM 2026-09-10T12:42:00+02:00 — Codex. Extrahera Granskas indikator till en gemensam komponent; wira den lokalt i respektive scrollägare, aldrig globalt. [Verifierat 2026-09-10 (Codex): alla tre äger en explicit `overflowY:auto`-rot. Årsboken har lång årsberättelse; cupfinalens andra slide har två hela elvor före startknappen; lönekraven kan rendera valfritt antal `demands` före bekräftelsen. Ingen senare git-commit ger dem en overflow-signal. Jacob har uttryckligen valt indikator även där den avskurna listan delvis signalerar scroll.] |
| portal-scrollindikator-saknas | I innehållsrika Portal-lägen fortsätter kort och ibland svarsalternativ bakom den fasta CTA-stacken utan en tydlig signal om att mer finns nedanför. | in_progress | Codex | `playtest/SCROLLINDIKATOR_SVEP_2026-09-10.md` + Jacobs fråga 2026-09-10 | CLAIM 2026-09-10T12:42:00+02:00 — Codex. Gör `GameShell`-scrollägaren tillgänglig för Portal och wira samma villkorade/klickbara indikator ovanför hela den uppmätta CTA-stacken, utan global GameShell-pil. [Verifierat 2026-09-10 (Codex): `GameShell.tsx` äger `scrollRef`; `PortalScreen.tsx` äger en separat fixerad, dynamiskt uppmätt `ctaRef`. Mobilproven `portal-full` och `portal-interruption-budget` visar eventinnehåll och svar bakom CTA-stacken. Ingen befintlig cue eller senare git-fix finns.] |
