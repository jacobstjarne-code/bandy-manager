...
| sluttest-kvalitativ-uppfoljning | Kvalitativ uppföljning med 6–8 riktiga spelare (paus efter omg 3, 11, 22, fem frågor) — ej genomförd | in_progress | Codex | SLUTTEST_KO.md:1270 | CLAIM 2026-09-10T17:42:35+02:00 — följ `SPELTESTKALENDER_2026-09-10.md`: bevara den fulla 6–8-spelarrundan som post-launch-uppgift och flytta den ur release-MASTER; Jacobs separata pre-release-nyspelarkörning ligger kvar i kalendern. |
