...
|---|---|---|---|---|---|
| grind2-nykarriar-kompletterande-aterprov | Separat nykarriärprov behöver sammanhängande återprov efter derbyfixen | in_progress | Codex/Astra | playtest/GRIND2_NYKARRIAR_LESJOFORS_2026-09-11.md + playtest/GRIND2_ATGARDSPASS_2026-09-11.md + playtest/GRIND2_DUBBELSPAR_ASTRA_2026-09-11.md | CLAIM 2026-09-11T12:34:01+02:00 — Codex/Astra. Kör ett nytt naturligt tvåsäsongsprov från början på medel, dubbelspår mot `TESTINSTRUKTION_GRIND2_ATERPROV_2026-09-10.md`, pinnat till `f993ddd22fd3db4cfdef38efb43649c2329aac78` (produktfix `1b213092` + arkivering; samtliga tre blockerarfixar i historiken). Styr tifovalet och omgång 9–11 så klackkonflikten får ett naturligt triggerfönster. Verifiera särskilt spelad kölivscykel, säsongsslutsbarriär, dedupe och svält; logga känslan separat. Tidigare återprov mot `6732d711` underkändes av kafferum och beslutskö; burnout och gala höll, klackkonflikten täcktes inte. |
