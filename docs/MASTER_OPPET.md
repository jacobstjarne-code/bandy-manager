...
|---|---|---|---|---|---|
| bandygala-dubblett-residual | Bandygalan 2034 surfade upp tre gånger under samma 2034/35-säsong trots den första dubbla-köfixen | in_progress | Code | Grind 2/3 långkarriär 2026-09-10 + `7629968a` | CLAIM 2026-09-10T23:56:25+02:00 — Code. Browserreproducerat på aktuell lokalt serverad `retireResolvedEvent`: samma titel, nomineringar och säsong i omgång 2, 5 och 7. Första fixen rensar samtidiga kopior ur `pendingEvents`/`deferredDecisions`, men legacy-/långkarriären kan fortfarande återföra en redan löst identitet när `resolvedEventIds` inte ensam bär kvittot. Bygg migrationssäkert beslutsköskydd mot både ID-cachen och durabel `resolvedChoices`, regressionstesta och fortsätt samma save. Aktiv räknare 7→8. |
...
| sluttest-validering-journal | Valideringsexperiment: följ-en-karriär-journalen — ej kört | in_progress | Code | SLUTTEST_KO.md:1268 + `TESTINSTRUKTION_KARRIARJOURNAL_2026-09-03.md` | CLAIM 2026-09-10T23:31:22+02:00 — Code. Rätt browser-save verifierad: `Västanfors Grindtest 2`, årsbok 2033/34 och CTA till nionde säsongen 2034/35. Den befintliga Grind 2/3-journalen dokumenterar åtta säsonger men uppfyller ännu inte denna rads egna tio-säsongskrav, fem slutfrågor eller save-export. Fortsätt samma save genom säsong 9–10, omforma/slutför journalen enligt instruktionen och exportera underlaget; aktiv räknare fortsatt 7 tills leveransen är komplett. |
