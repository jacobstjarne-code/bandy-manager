...
| inv-4-o12-forhandsdelta | O12 "förhandsdelta" (DOM_DOMINANS_OCH_FORHANDSDELTAN) skriven men aldrig byggd | verifierad | Code/Opus | INVENTERING_2026-08-31.md:103 + SLUTTEST_KO.md:1060 | MEKANISK DEL KLAR `06336d37` — Codex. `ResolvedChoice` bär nu stabilt `resolutionId` + instanssant `decisionKind`; entropin exkluderar enknappskvittenser och deduplicerar exporter utan att tappa flera steg i samma event. Rotfelen verifierades med 3 nya mobilkarriärer/exportsaves och regressionstestas för både `Noterat` och transferkedjan. Fokus 14/14, build grön, full svit 539 filer/4 931 tester grön. Fullt belägg: `RAPPORT_O12_VALENTROPI_BROWSER_2026-09-09.md`. KVAR: Opus/Code delar `EventChoice` i riktad kvalitativ förhandsbeskrivning och exakt efterkvitto; därefter nytt browserprov på deploy och naturlig population för 80 %-grinden. Ingen eventtyp-blacklist eller regex-suddning. D1:s ambientväg och O5 finns redan. Dedup 2026-09-03: konsoliderar `sluttest-o12-forhandsdeltan`. |
