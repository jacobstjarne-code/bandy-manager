...
| scout-shortlist-transferfonster | Bevakad spelare som fortfarande är tillgänglig när transferfönstret stänger kan vara värd en rad — bygg när transferytorna ändå rörs | in_progress | Codex | BACKLOG.md:76 | Medvetet parkerad (BACKLOG.md:76) — bygg vid nästa transfers-yterörelse. CLAIM 2026-09-10T00:20:39+02:00 — Codex: reconcile mot listans uttryckliga parkeringsstatus. |
