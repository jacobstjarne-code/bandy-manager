...
| trott-startelva-raknare-fel-population | Bekräftelserutan säger samtidigt "15 av 11 har minst 22 % kondition" och "Du har inte elva spelare med tillräcklig kondition". | rapporterad | Code | Grind 2, 2030/31 omg 8, 2026-09-10 | Verifiera vilken population räknaren och startelvakravet använder; rätta gemensam härledning i stället för copy-specialfall. |
| bandygala-dubblett-samma-sasong | Exakt samma \`Bandygalan 2031\` med samma fem pristagare visades och hanterades i både omgång 2 och omgång 6 under säsong 2031/32. | rapporterad | Code | Grind 2, 2031/32 omg 2 + 6, 2026-09-10 | Kodläs rollover-eventets stabila \`event_gala_{season}\`-id mot resolution och båda eventköerna. Nuvarande budgetkod ska deduplicera stabila id:n; verifiera om äldre save-data bär två identiteter eller om resolutionen lämnar en kökopia. Ingen copyfix. |
| burnout-dubbelt-slutval-samma-sasong | Burnout-taket visades två gånger 2031/32. Efter `Kliv tillbaka en period` i omgång 11 gick samma återfallsdilemma att välja igen efter semifinal 5; `Kör vidare` gjorde att årsboken påstod båda oförenliga slutvalen under samma vår. | rapporterad | Code | Grind 2, 2031/32 omg 11 + semifinal 5, 2026-09-10 | Kodläs generationens säsongsgate och resolution. Ett slutgiltigt burnout-val ska få en deklarerad state-effekt och högst en kanonisk säsongspost; bygg inte bort motsägelsen bara i årsbokstexten. |
| historikankare-skiftar-inom-sasong | Samma frysta burnout-beslut visades som `4 år sedan` i omgång 12 men `3 år sedan` i semifinal 3–5, fortfarande under 2031/32. | rapporterad | Code | Grind 2, 2031/32 omg 12 + semifinal 3–5, 2026-09-10 | Spåra vilken tidsaxel portalankaret läser före och efter grundserien. Läs och presentera samma säsongs-/liggarskala genom hela säsongen; ingen fasbaserad copy-special. |
| kafferum-exakt-aterfall-samma-slutspel | Exakt repliken `Det ringde tre gamla medlemmar...` visades före semifinal 1 och 4 både 2030/31 och 2031/32. | rapporterad | Code | Grind 2, två raka säsongers semifinaler, 2026-09-10 | Kodläs kafferummets urval och narrativeBeatLog-cooldown. Detta är presentationstiming, inte händelsekanon; behåll gränsen mot eventLedger. |
