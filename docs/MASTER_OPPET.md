...
| id | beskrivning | status | ägare | källa | nästa-åtgärd |
|---|---|---|---|---|---|
| portal-kograf-svarlast | Portalens I kö-kort visar en graf vars innebörd och riktning är svår att förstå | rapporterad | — | Grind 2-skärmbild 2026-09-11 | Verifiera grafens datakälla, tidsriktning och om axelordet Tryck/Lugn beskriver värde eller ändpunkt; föreslå en svensk, självbärande presentation utan ny sekundär mätning. |
| arsbok-tidslabel-normalisering | Årsbokens tidslinje blandar Omg, Dag och intern matchday-semantik | rapporterad | — | Grind 2-skärmbild 2026-09-11 | Normalisera spelarens etiketter utan att kalla global matchdag för ligaomgång. Liga får Omg N; cup/slutspel får tävlingsnamn; ofrysta narrativa händelser behöver sann, icke-pseudoprecis etikett. |
| arsbok-akademi-singular | Akademiraden skriver “1 stjärnor” | rapporterad | — | Grind 2-skärmbild 2026-09-11 | Böj stjärna/stjärnor från faktisk mängd i båda kanoniska presentationsvägarna och regressionstesta singular/plural. |
...
| licensavdrag-text-och-rollover | Licensbrevet säger “Tre poäng” och ett nytt avdrag aktiveras en säsong för sent | in_progress | Codex | Grind 2-skärmbild 2026-09-11 + seasonEndProcessor.ts:1495–1522,2427–2438 | CLAIM 2026-09-11T09:31:00+02:00 — Codex. `handleSeasonEnd` skapar −3 i `licensePendingDeductions` men har redan satt den nya säsongens `pointDeductions` enbart från föregående pending-värde. Beslutet vid 2038/39 års slut blir därför aktivt först 2040/41 trots texten “nästa säsong”. Flytta samma-rollover-licensavdraget till den aktiva sammanslagningen, bevara redan väntande skandalavdrag och regressionstesta tabellpoängen. |
