...
|---|---|---|---|---|---|
| high6-retirement-golvalder-fitnessensam | Finare punkt Jacob noterade men INTE auditens critical: även med golvet kan en spelare EXAKT på golvåldern (ageScore=0) bli kandidat av fitness/skador ensamt — t.ex. en 29-årig forward som bara är trött denna säsong. Balansnyans, inte en bugg. | in_progress | Codex | Jacobs egen anteckning i körordern 2026-08-31 (medveten, ej rapporterad som fel) | CLAIM 2026-09-10T15:49:47+02:00 — Codex. Jacob dömde 2026-09-10: låg kondition ensam får inte göra en spelare under ordinarie positionsålder till pensionskandidat; inom fyrårsmarginalen krävs faktisk skadehistorik, som konditionen får förstärka. Ändra inte `RETIREMENT_AGE_MARGIN`. Tidigare verifiering: ren designfråga, nu avgjord. |
