...
| pending-screen-kedja-stannar | Direkt kedja mellan två obligatoriska pending-skärmar kan stanna på dashboarden efter den första skärmen | rapporterad | — | Grind 2-återprov 2026-09-11 | Naturligt återprov reproducerade `qf_summary` → `season_summary`: säsongen rullade men dashboarden visade ett icke-klickbart lås i stället för att öppna årsboken. Verifiera om omdirigeringsvakten minns bara boolesk status och därför inte ser att skärmens identitet ändrats. |
