...
|---|---|---|---|---|---|
| granska-scrollindikator-osynlig | Granska kräver nästan alltid scroll, men den befintliga scrollpilen är så liten och lågkontrast att spelaren inte uppfattar att mer innehåll finns nedanför resultatkortet. | rapporterad | Code | Jacobs speltest 2026-09-10 + `/dev/scenes?scene=granska&inspect=1&width=390` | Verifiera mot den faktiska scrollbehållaren, villkoret och mobilrenderingen. Om fyndet håller: gör indikatorn tydlig och klickbar utan att ta permanent innehållsyta. |
