...
| sponsor-motbud-kopromotion-saknas | Sponsorers motbudsutfall lämnar uppskjutna beslut i kön trots att en aktiv plats frigjorts | rapporterad | Code | Grind 2-hypotespass 2026-09-11 | Läs båda terminala motbudsgrenarna i `gameStore.ts` mot den kanoniska resolutionens direkta `promoteFromQueue`-övergång och git-historiken. Verifiera om accepterat motbud respektive walkaway kan lämna `deferredDecisions` osurfad till nästa omgång; bygg inte före verifiering och claim. Aktiv räknare 5→6. |
