...
| id | beskrivning | status | ägare | källa | nästa-åtgärd |
|---|---|---|---|---|---|
| arsbok-ortsstod-kontext | Årsboken visar naket “Lokalstöd 0” utan skala | in_progress | Codex | Grind 2-skärmbild 2026-09-11 + SaveGame.ts:576 + SeasonSummaryScreen.tsx:961–990 | CLAIM 2026-09-11T09:52:00+02:00 — Codex. `communityStanding` startar på 50, är uttryckligen en 0–100-skala och alla uppdateringar klampas; 0 är därför ett giltigt långkarriärutfall, inte saknad data. Visa `{värde} av 100` så golvet går att tolka. Behåll faktiska `communityShift`-rader men fabricera ingen orsak när historiken saknar en. |
