...
| sponsor-motbud-kopromotion-saknas | Sponsorers motbudsutfall lämnar uppskjutna beslut i kön trots att en aktiv plats frigjorts | verifierad | Code | Grind 2-hypotespass 2026-09-11 | Kod- och historikkontroll: `commitSponsorCounter` infördes i `3dd2503e` och båda terminala grenarna står kvar utanför den promotion som vanliga `resolveEvent`, veckobeslut och marknadsbeslut gör. `walked_away` tar endast bort den synliga posten och `accepted` anropar domänresolvern direkt; ingen gren kör `promoteFromQueue`, och inga store-tester täcker övergången. Med en icke-tom `deferredDecisions` frigörs alltså en plats utan att nästa beslut surfar förrän senare omgångsunderhåll. Claim och bygg gemensam slutstegspromotion för båda utfallen; `stood_firm` ska fortsatt lämna kön orörd eftersom inget beslut avslutats. Aktiv räknare fortsatt 6. |
