...
|---|---|---|---|---|---|
| bandygala-aterkomst-efter-durable-receipt | Bandygalan 2034 återkom en fjärde gång i omgång 10 trots skydd mot både `resolvedEventIds` och `resolvedChoices` | in_progress | Code | Grind 2/3 långkarriär 2026-09-11 + `4a97deb3` | CLAIM 2026-09-11T00:03:20+02:00 — Code. Browserreproducerat omedelbart efter det första residualskyddets verkliga spelverifiering: samma frysta gala 2034 visades åter efter omgång 10. Det falsifierar att köskyddet ensamt löser producentvägen. Kortet lämnas olöst i den auktoritativa saven; spåra faktisk eventidentitet och säsongsslutets producent/requeue-väg, bygg klasslösningen, regressionstesta och återuppta samma save. Aktiv räknare 7→8. |
