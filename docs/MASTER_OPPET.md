...
|---|---|---|---|---|---|
| granska-scrollindikator-osynlig | Granska kräver nästan alltid scroll, men den befintliga scrollpilen är så liten och lågkontrast att spelaren inte uppfattar att mer innehåll finns nedanför resultatkortet. | in_progress | Codex | Jacobs speltest 2026-09-10 + `/dev/scenes?scene=granska&inspect=1&width=390` | CLAIM 2026-09-10T12:17:00+02:00 — Codex. Gör indikatorn tydlig och klickbar utan att ta permanent innehållsyta. [Verifierat 2026-09-10 (Codex): `GranskaScreen.tsx` har rätt intern scrollbehållare och mäter kvarvarande innehåll, men renderar bara ett 12 px `↓` i en 22 px hög toning ovanför bottenpanelen. Mobilprovet 390 px visar att tecknet visuellt försvinner mot statistikens avdelare; git-historiken innehåller ingen senare synlighetsfix.] |
