...
|---|---|---|---|---|---|
| grind2-nykarriar-kompletterande-aterprov | Separat nykarriärprov behöver sammanhängande återprov efter derbyfixen | rapporterad | Codex/Astra | docs/playtest/GRIND2_DUBBELSPAR_ASTRA_F993DDD2_2026-09-11.md | **UNDERKÄND 2026-09-11 mot pinnad `f993ddd2`.** Två säsonger på medel avslutade; efter första anslagsstoppet fortsatte provet diagnostiskt genom att enbart markera blockerande anslag som sedda i den isolerade saven. Den tidigare olösbara säsongsslutskön är löst: gamla burnout-kort var synliga och lösbara, budgeten höll max tre, klackkonflikten promoterades till fruset Granska och löstes exakt en gång. Burnout-tak, kafferumscooldown, gala och kanonisk klackkonflikt höll i observerad population. Fyra nådda releaseblockerare är registrerade nedan: anslagsdismiss låser portalen, motståndarspelare får eget klubbval, årsbok/objektiv motsäger sig och avvisat transferbud dubblas som pending. Grind 2 får inte arkiveras. |
| grind2-anslag-dismiss-laser-portalen | Kapitelanslagets ”Tryck för att fortsätta” låser portalens huvudtråd och lämnar anslaget kvar efter omladdning | rapporterad | Code | docs/playtest/GRIND2_DUBBELSPAR_ASTRA_F993DDD2_2026-09-11.md | Reproducerat först vid `league_halfway`, därefter samma beteende vid `league_midwinter`, `playoff_qualification`, `regular_done` och `season_done` på 390×844. Hårt kärnflödesstopp. Reparera dismisskedjan och browserprova samtliga fem anslag med vanlig klick + reload; ingen direktmanipulation av `seenAnslag` får krävas. |
| grind2-motstandarspelare-eget-klubbval | Granska kan generera karriär-/motivationsval för en spelare som tillhör motståndaren | rapporterad | Code | docs/playtest/GRIND2_DUBBELSPAR_ASTRA_F993DDD2_2026-09-11.md | `hungrig_wants_more_player_club_halleforsnas_5` visade ”Jonathan Claesson vill kliva upp” för Karlsborgs tränare trots att Claesson tillhörde Hälleforsnäs. Gör både producent och resolver klubbägarsäkra; regression med motståndarspelare i slutspels-Granska. |
| grind2-arsbok-objektiv-sanningssplit | Årsbok och portal visar motstridig styrelsedom och gammal objektivprogress i ny säsong | rapporterad | Code | docs/playtest/GRIND2_DUBBELSPAR_ASTRA_F993DDD2_2026-09-11.md | Samma årsbok sade ”Styrelsen fick mer än de bad om” och ”ett uppdrag missades”; nästa säsong startade med föregående `Gå långt i cupen 2/3` och `Slå Rögle 1/1` under nya mål. Frys en gemensam säsongssanning för hero/dom/historik och nollställ ny progress utan att radera historiken. |
| grind2-transferbud-avvisat-och-pending | Ett avvisat inkommande bud återstår samtidigt som pending med samma id och fortsätter kräva svar | rapporterad | Code | docs/playtest/GRIND2_DUBBELSPAR_ASTRA_F993DDD2_2026-09-11.md | Checkpoint efter `event_gala_2026` innehåller två `transferBids` med id `bid_2_player_club_karlsborg_10_club_malilla`, status `rejected` respektive `pending`, samtidigt som event-id:t är löst. Portalen visar ändå ”svar krävs”. Gör statusövergången atomär över budlista, köer och `resolvedEventIds`; dedupe-regression från checkpointen. |
