...
| id | beskrivning | status | ägare | källa | nästa-åtgärd |
|---|---|---|---|---|---|
| portal-kograf-svarlast | Portalens I kö-kort visar en graf vars innebörd och riktning är svår att förstå | in_progress | Codex | Grind 2-skärmbild 2026-09-11 + PortalQueueRail.tsx:112–130 | CLAIM 2026-09-11T09:47:00+02:00 — Codex. Grafen är `fatigueHistory` i tidsordning, men vänsterordet “Tryck” och högerordet “Lugn” ser ut som två axeländar fast “Lugn” egentligen är nuläget. Skriv “Beslutsbörda” + “Nu: {nivå}” och märk tidsriktningen “Senaste omgångarna →”; behåll samma state och sparkline. |
