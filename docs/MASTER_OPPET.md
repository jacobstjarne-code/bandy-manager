...
| arsbok-tidslabel-normalisering | Årsbokens tidslinje blandar Omg och Dag för två olika skalor | in_progress | Codex | Grind 2-skärmbild 2026-09-11 + SeasonSummaryScreen.tsx:47–72 | CLAIM 2026-09-11T09:40:00+02:00 — Codex. Fixture-händelser bär redan sann `roundLabel` (`Omg N`, cup eller slutspel). Storylines utan fixture faller däremot till `Dag {global matchday}`, en intern kalenderposition som spelaren inte kan tolka. Behåll tävlingsetiketterna och ersätt bara den obelagda sifferfallbacken med kompakta “Säsongen”; kalla aldrig global matchdag för ligaomgång. |
