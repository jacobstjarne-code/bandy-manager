...
| transfers-modaler-ledgervokabular | BidModal/RenewContractModal ska få ledger-vokabulär (designidé, öppen fråga) | in_progress | Codex | BACKLOG.md:418, 419 | **→ CLAIM 2026-09-10T11:15:18+02:00 — Codex.** vänta Jacobs beslut [Verifierat 2026-09-01 (Code): docs/BACKLOG.md:418 listar "#7 transfers-modaler (BidModal/RenewContractModal) → ledger-vokabulär (designidé, öppen fråga Opus/Jacob)" som ej löst.] **→ 2026-09-09 (Jacob): INTE parkerad — vill veta mer. Opus utredde (kodläst BidModal/RenewContractModal): modalerna är rent transaktionella (budget, marknadsvärde, lön, år, kontraktstermer, en rivalitetsvarning) och rör ALDRIG liggaren/minnet som nu definierar spelet. 'Ledger-vokabulär' = yta spelarens minnesstånd i själva transaktionen — att lägga bud på en klackfavorit/legend eller förlänga en som bär en transfer_story ska bära minnets vikt, inte bara siffror. Verklig design-idé (Jacobs instinkt stämmer: liggaren är stor, att den inte rört transaktionsspråket är en glugg), men ingen tydlig lucka — blir en Design-brief om Jacob vill ta den. Ägare Opus/Design.** **→ 2026-09-10 (Jacob: bygg). Brief `DESIGN-BRIEF-TRANSFERS-LEDGERVOKABULAR-2026-09-10`, Design mockade (`Transfers-liggarvokabular.dc.html` + `HANDOFF-TRANSFERS-LIGGARVOKABULAR.md`), Opus granskade + godkände. Kodgrundat: liggaren = EN sanning ytad på två ställen (Klubbminnet bakåt, transfers framåt, samma `getClubMemory`). HÅLL: `buildPlayerLedger` ska returnera 0–3 rader (inte minst 1) — rotlös/nyköpt spelare läser rent transaktionellt, vikten fabriceras aldrig. Byggbar av Code mot handoffen, inga nya fält. KVAR Opus: strängpoolerna (§4 — liggar-rader per proxytyp, verdict emot/för, rivalvarning per derby).** **→ LEVERERAT 2026-09-10: `OPUS_STRANGPOOLER_2026-09-10.md` (18 liggar-rader + verdict ×10 + rivalvarning ×9). Jacob låste `buildPlayerLedger` 0–3, tom liggare för rotlös spelare, ingen fallbacktext. Code-passet entydigt byggbart mot handoffen.** |
