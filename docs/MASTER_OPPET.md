...
**10 aktiva poster återstår:** nio nya rader från det låsta breda sexsäsongsprovet samt `stickiness-drift-backend`. Räkna endast faktiska datarader med status `rapporterad`, `verifierad` eller `in_progress`; historiska räknarändringar och stängda poster finns i `docs/MASTER_ARKIV.md`.
...
|---|---|---|---|---|---|
| sexsasong-beslutslivscykel | Säsongsslut gav 4 aktiva beslut trots max 3 i 4 nådda tillstånd; nio lösta event-id:n återkom senare eller via kvarvarande kökopia (politiker, spelarpar, transferbud, community och starPerformance) | in_progress | Codex | `docs/playtest/BRETT_SEXSASONGSPROV_ASTRA_87DD3EFF_2026-09-12.md` | CLAIM 2026-09-12T15:40:59+02:00 — Codex. Verifierad mot kod och historik: säsongsslutet saknar en sista gemensam budgetpartition och flera producenter blandar beständiga, säsongsbundna och konkreta id:n. Rotfix: en slutlig central partition samt kanoniskt instans-id + semantic-id genom hela livscykeln. |
| sexsasong-klackkonflikt-durabel | `supporter_conflict_<season>` återstartade i senare säsonger i 7/10 karriärer där scenen nåddes | in_progress | Codex | samma sexsäsongsrapport | CLAIM 2026-09-12T15:40:59+02:00 — Codex. Verifierad mot kod och historik: producenten läser endast `conflictSeason !== currentSeason`, inte liggarens långtidsidentitet. Behåll säsongs-id som instans-id och grinda med durabel semantic-id. |
| sexsasong-ai-intag-alder | AI:s `generateYouthIntake` skapar 15–19-åriga seniora `Player` och lägger dem direkt i `game.players`/`squadPlayerIds`, medan domäninvarianten kräver 16–42; ordinarie stress stannar efter första rollover | in_progress | Codex | samma sexsäsongsrapport | CLAIM 2026-09-12T15:40:59+02:00 — Codex. Verifierad mot kod, kontrakt och historik: managed P19 får vara 15–19 men AI-intaget materialiseras direkt som senior `Player`. Ändra AI:s intervall till 16–19; försvaga inte invarianten. |
| sexsasong-kafferum-turmodell | 43 kafferumsrader bär en tredje talare inklistrad i fyrfältets `textB`; tvåtalar-rendern visar talarnamn och citattecken som rå löptext | in_progress | Codex | samma sexsäsongsrapport, parallell textgranskning | CLAIM 2026-09-12T15:40:59+02:00 — Codex. Verifierad mot renderer, data och historik: fyrfältet kan bara uttrycka två talare. Rotfixa modellen till strukturerade talarturer och migrera trepartsutbyten strukturellt. |
| sexsasong-sent-mal-kontext | `goalLate` väljs före kvittering/reducering/utökning, så ”det slutar inte här”/”ger oss” kan spelas när motståndaren utökar | in_progress | Codex | samma sexsäsongsrapport, parallell textgranskning | CLAIM 2026-09-12T15:40:59+02:00 — Codex. Verifierad mot urvalsordning och historik: senflaggan föregår matchlägesklassningen. Klassificera först och välj bara sena formuleringar som är sanna för läget, utan balansändring. |
| sexsasong-mobil-taktik-overlap | Taktikvalens etiketter överlappar vid 375, 360 och 320 px; `BALANSERAD` lämnar sin knapp | in_progress | Codex | samma sexsäsongsrapport, grafisk granskning | CLAIM 2026-09-12T15:40:59+02:00 — Codex. Verifierad i komponenten och vid tre målbredder: fast 78 px-etikettkolumn kolliderar med kontrollen. Rotfixa layouten responsivt och lägg visuellt skydd. |
| sexsasong-portal-fast-krom | Portalens fasta CTA, scrollindikering och tonade bottenband följer hela desktopfönstret i stället för spelets max 430 px-kolumn | in_progress | Codex | samma sexsäsongsrapport, grafisk granskning | CLAIM 2026-09-12T15:40:59+02:00 — Codex. Verifierad mot PortalScreen/ScrollMoreCue och BottomNav-kontraktet. Centrera fast krom och begränsa den till spelkolumnens maxbredd. |
| sexsasong-visuellt-testskydd | Burnout/klack/konflikt finns som dev-scener men inte i visuella registret; galan saknar scen/register; `annandagen` provar inte den riktiga laddningsbilden | in_progress | Codex | samma sexsäsongsrapport, grafisk granskning | CLAIM 2026-09-12T15:40:59+02:00 — Codex. Verifierad mot scenregistret och historik. Registrera illustrationerna, bygg en sann galascen och låt annandagen prova verklig bildladdning. |
| sexsasong-textytor-finlir | Säkra synliga fel återstår i formation-/sponsor-enum, venue/pronomen, kryssantal, svenska ord/sammansättningar, slutspelsord och decimalformattering | in_progress | Codex | samma sexsäsongsrapport, parallell textgranskning | CLAIM 2026-09-12T15:40:59+02:00 — Codex. Verifierad genom exakt textsökning, formatteringsspårning och historik. Ta hela listan som ett sammanhållet textsanningspass och använd befintliga label-/decimalformatterare. |
