...
|---|---|---|---|---|---|
| grind2-nykarriar-kompletterande-aterprov | Separat nykarriärprov behöver sammanhängande återprov efter derbyfixen | in_progress | Codex/Astra | playtest/GRIND2_NYKARRIAR_LESJOFORS_2026-09-11.md + playtest/GRIND2_ATGARDSPASS_2026-09-11.md | CLAIM 2026-09-11T10:52:50+02:00 — Codex/Astra. Kör dubbelspår (logik + känsla) mot `TESTINSTRUKTION_GRIND2_ATERPROV_2026-09-10.md`, från ny karriär på medel. Kodpinne före start: `6732d711d5f3b0053bb71ec0311dae6ca0e8f9ec`. Tidigare återlämning: 5 137 tester och full build gröna; nio riktade checkpoint/scenkontroller täcker tidigare burnout-val, båda derbyekona och klackkonfliktens tre val i två säsongslägen med före/eftersaves och reload. Den parallella Grind 2-passdomen står kvar som egen körning; den gör inte detta nykarriärprov rent i efterhand. |
