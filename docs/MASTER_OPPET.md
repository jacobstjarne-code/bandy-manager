...
| grind2-ko-sasongsslut-oloslig | Beslutskön visar aktiva val efter slutspelsuttåg men erbjuder inget lösbart Granska-kort före Avsluta säsongen | rapporterad | Codex/Astra | playtest/GRIND2_DUBBELSPAR_ASTRA_2026-09-11.md | Repro: 2027/28 efter QF3, portal 16 i kön/3 aktiva; enda CTA Avsluta säsongen och Match säger Säsongen är slut. Verifiera terminalövergångens promotion/routing och gör varje fruset Granska-val lösbart eller explicit pensionerat före rollover. |
| grind2-ko-rolloverflood-semantisk-dedupe | Gamla uppskjutna beslut svälter och samma vardagsjobb återkommer semantiskt över pending, deferred och rollover-rapporter | rapporterad | Codex/Astra | playtest/GRIND2_DUBBELSPAR_ASTRA_2026-09-11.md | Repro: 21 rapporter vid första rollover, 16 vid andra, ålder upp till 35 globala omgångar; Hugo Bergs ”Jobbet kolliderar med träningen” minst 5+3 gånger. Verifiera identitet över pending+deferred+resolved/expired och att åldersprioritering faktiskt tömmer deadline-lösa beslut utan inkorgsflood. |
| grind2-portalbudget-slutspel-fyra-aktiva | Portalen kan visa fyra aktiva avbrott trots låst budget max tre | rapporterad | Codex/Astra | playtest/GRIND2_DUBBELSPAR_ASTRA_2026-09-11.md | Repro vid slutspelsintroduktionen 2027/28: 4 aktiva, 13 i kö. Kartlägg vilka producenter UI-räknaren respektive `partitionInterruptBudget` tar med och inför en gemensam kanonisk räkning som inkluderar portal-/slutspelshandlingen. |
