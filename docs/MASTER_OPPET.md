...
|---|---|---|---|---|---|
| grind2-nykarriar-kompletterande-aterprov | Separat nykarriärprov behöver sammanhängande återprov efter derbyfixen | verifierad | Codex/Astra | playtest/GRIND2_NYKARRIAR_LESJOFORS_2026-09-11.md + playtest/GRIND2_ATGARDSPASS_2026-09-11.md + playtest/GRIND2_DUBBELSPAR_ASTRA_2026-09-11.md | Återprovet 2026-09-11 är genomfört från ny karriär på medel mot produktpinne `6732d711d5f3b0053bb71ec0311dae6ca0e8f9ec` och **underkänt**. Burnout och gala höll; kafferum och beslutskö bröt invarianter; kanonisk klackkonflikt triggades aldrig och är därför ej täckt. Grindrader arkiveras inte. Fem specifika följdrader nedan måste genom tillståndsmaskinen före nytt naturligt återprov. |
| grind2-gala-gestaltning | Galan saknar dramatisk tyngd trots tekniskt engångsutfall | rapporterad | Opus/Jacob | playtest/GRIND2_ATGARDSPASS_2026-09-11.md + playtest/GRIND2_NYKARRIAR_LESJOFORS_2026-09-11.md | Bedöm ett kort förspel, val och reaktion/landning med befintliga scenmönster. Inget ombygge utfört; kräver designbeslut separat från den återställda mecenatmiddagen. Inga nya belöningar eller balansändringar ingår. |
| grind2-kafferum-fatiguepool-cooldown | Generella fatigue-repliker i kafferummet återkommer inom samma säsong trots kravet på två säsongers cooldown | rapporterad | Codex/Astra | playtest/GRIND2_DUBBELSPAR_ASTRA_2026-09-11.md | Verifiera producenten i `coffeeRoomService`: `coffee_pool_<index>` skrivs till liggaren men fatigue-selektorn använder bara den korta `lastCoffeeSceneIndices`-svansen. Koppla urvalet till den kanoniska tvåsäsongscooldownen och regressionstesta de tre exakta reprofamiljerna utan att tunna ut dramatiken. |
| grind2-ko-sasongsslut-oloslig | Beslutskön visar aktiva val efter slutspelsuttåg men erbjuder inget lösbart Granska-kort före Avsluta säsongen | in_progress | Codex/Astra | playtest/GRIND2_DUBBELSPAR_ASTRA_2026-09-11.md | VERIFIERAD 2026-09-11: `GranskaScreen` fryser `pendingEvents` vid mount samtidigt som `resolveEvent` kan promovera nästa uppskjutna val; det nya kortet kommer därför aldrig in i vyn och slutrundan saknar en senare Granska-passering. CLAIM 2026-09-11T11:41:00+02:00: gör Granska-kedjan levande tills alla öppningsbara val är lösta eller uttryckligen pensionerade. |
| grind2-ko-rolloverflood-semantisk-dedupe | Gamla uppskjutna beslut svälter och samma vardagsjobb återkommer semantiskt över pending, deferred och rollover-rapporter | in_progress | Codex/Astra | playtest/GRIND2_DUBBELSPAR_ASTRA_2026-09-11.md | VERIFIERAD 2026-09-11: rollover skapar en separat inkorgspost per uppskjutet val och utgångna val lämnar inget kanoniskt resolutionskvitto; vardagsjobbets id innehåller femomgångsperiod och `alreadyQueued` saknar `resolvedChoices`. CLAIM 2026-09-11T11:41:00+02:00: bär exakt och semantisk identitet genom pending, deferred, resolved/expired och rollover samt gör terminalen till en barriär utan inkorgsflood. |
| grind2-portalbudget-slutspel-fyra-aktiva | Portalen kan visa fyra aktiva avbrott trots låst budget max tre | in_progress | Codex/Astra | playtest/GRIND2_DUBBELSPAR_ASTRA_2026-09-11.md | VERIFIERAD 2026-09-11: budgetpartitionen släpper alltid fram samtliga nära deadline samtidigt som den kan reservera veckoval, och `getActiveDecisionCount` räknar inte portalens aktiva scen. CLAIM 2026-09-11T11:41:00+02:00: en gemensam kanonisk budget på högst tre över event, veckoval och scen. |
| grind2-arsbok-styrelsekrav-motsags | Årsboken beskriver 9:e/8:e plats som uppfyllt eller överträffat krav trots portalens och inkorgens mål Sluta topp 6 | rapporterad | Codex/Astra | playtest/GRIND2_DUBBELSPAR_ASTRA_2026-09-11.md | Repro båda säsongerna. Låt årsbokens bedömning läsa samma säsongsbundna mål/resolution som portal och inbox; täck även att samma derbytriumf inte skrivs två gånger i årsboken. |
