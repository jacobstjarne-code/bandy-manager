...
| burnout-dubbelt-slutval-samma-sasong | Burnout-taket visades två gånger 2031/32 och tre gånger 2033/34. Först gav motsatta val en motsägelsefull årsbok; sedan gav samma val ändå två identiska permanenta scar-rader. | in_progress | Codex · 2026-09-10 22:58 CEST | Grind 2, 2031/32 omg 11 + semifinal 5 samt 2033/34 omg 8 + kvart 4 + semi 1, 2026-09-10 | Kodläs generationens säsongsgate och resolution. Ett slutgiltigt burnout-val ska få en deklarerad state-effekt och högst en kanonisk säsongspost; bygg inte bort motsägelsen bara i årsbokstexten. |
| historikankare-skiftar-inom-sasong | Samma frysta burnout-beslut skiftade `4 år sedan`→`3 år sedan` under 2031/32 och `1 år sedan`→`4 år sedan` mellan omgång 13 och semifinal 3 under 2032/33. | rapporterad | Code | Grind 2, två reproduktioner 2031/32–2032/33, 2026-09-10 | Spåra vilken tidsaxel portalankaret läser före och efter grundserien. Läs och presentera samma säsongs-/liggarskala genom hela säsongen; ingen fasbaserad copy-special. |
