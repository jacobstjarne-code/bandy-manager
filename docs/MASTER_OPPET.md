...
|---|---|---|---|---|---|
| arsbok-hero-platta-for-opak | Årsbokens resultatyta är för opak mot bakgrundsillustrationen och läser varken som tydlig bild eller avsiktlig glasplatta. | rapporterad | — | Jacobs browserfeedback 2026-09-11 | Verifiera nuvarande plattstyrka i kod och mobilvy; sänk opaciteten så motivet syns utan att resultattextens kontrast tappas. |
