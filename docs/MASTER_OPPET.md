...
| ci-scene-taktik-linux-reseed | `scene-taktik`-baselinen bryts avsiktligt av den godkända högre knappen och måste reseedas på Linux före release | rapporterad | Code | Jacobs instruktion 2026-09-10; `ci-en-primary-taktik-hierarki` | Granska att diffen enbart motsvarar den avsiktliga höjdändringen. Kör därefter Linux-CI-reseed via `visual-baselines.yml` och full publicerings-CI. Rör ingen lokal baseline; arkivera först när Linux-baselinen och publiceringsgrinden är gröna med körnings-id som belägg. |
