...
| analytics-dev-scen-sasongshistorik | AnalyticsBridge/analyticsLifecycle kan krascha när en dev-save saknar seasonSummaries. | verifierad | Codex | Speltestjournal 2026-09-10; aktuell 9e2a8af7 har fortsatt oskyddad length/iteration, nya browserförsöket timeoutade. | Kod/git verifierade på 9e2a8af7: AnalyticsBridge läser game?.seasonSummaries.length, initializeAnalyticsBaseline och syncGameAnalytics itererar utan fallback. DevScenesScreen.makeGame saknar fältet. Skydda konsumenterna mot saknad historik; ingen migration eller ändring av sparningar. Testa tom historik och befintliga riktiga milstolpar. |
