...
| analytics-dev-scen-sasongshistorik | AnalyticsBridge/analyticsLifecycle kan krascha när en dev-save saknar seasonSummaries. | rapporterad | Codex | Speltestjournal 2026-09-10; aktuell 9e2a8af7 har fortsatt oskyddad length/iteration, nya browserförsöket timeoutade. | Reproducera mot färdig telemetri, verifiera scope och åtgärda utan att ändra riktiga sparningar. Behåll återkontrollen separat från den redan arkiverade V1-leveransen. |
