...
|---|---|---|---|---|---|
| arsbok-hero-platta-for-opak | Årsbokens resultatyta är för opak mot bakgrundsillustrationen och läser varken som tydlig bild eller avsiktlig glasplatta. | in_progress | Codex · 2026-09-11T10:12:41+0200 | Jacobs browserfeedback 2026-09-11 | Kodkontroll: plattan blandar in 86 % solid `var(--bg)` och döljer därför huvuddelen av motivet; sänk opaciteten och bevara textkontrasten. |
| grind2-burnout-aterfall-valtext | Återfallsmarkören antar fel tidigare burnout-val | in_progress | Codex | playtest/GRIND2_NYKARRIAR_LESJOFORS_2026-09-11.md | CLAIM 2026-09-11T10:12:00+02:00 — Codex (nykarriärspåret). Verifierat 2026-09-11 mot a36d60d4 och filhistorik: BurnoutMark läser fasta BURNOUT_MARK_RELAPSE-pooler utan föregående val; checkpoint 00689 har stepped_back. Läs faktiskt terminalt val; bevara citatidentiteter och cooldown. |
| grind2-berattelse-matchfakta | Matchtexter, januari och interaktivt hörnmål motsäger fixture/state | in_progress | Codex | playtest/GRIND2_NYKARRIAR_LESJOFORS_2026-09-11.md | CLAIM 2026-09-11T10:12:00+02:00 — Codex (nykarriärspåret). Verifierat 2026-09-11 mot a36d60d4 och filhistorik: pepTalkService räknar råpoäng; PreMatchContext använder tabell även i KO; nextOpponentTeaser utesluter KO-möten; anslagService triggar januari direkt efter annandagen; interaktivt hörnmål sätter isCorner, inte isCornerGoal. Tävlings-, hemma/borta- och kalenderförankra; granska landslagsfrånvaro och hörnstatistik. Ingen balansändring. |
| grind2-inkorg-aktualitet | KRÄVER SVAR, introgrind och uppskjutna berättelser saknar sann aktualitet | in_progress | Codex | playtest/GRIND2_NYKARRIAR_LESJOFORS_2026-09-11.md | CLAIM 2026-09-11T10:12:00+02:00 — Codex (nykarriärspåret). Verifierat 2026-09-11 mot a36d60d4 och filhistorik: InboxScreen sätter styrelse/skador/skandal till kräver-svar utan beslut; topicIsReady undantar alla ACTIONABLE_TYPES och voiceIsReady bara press. Uppskjutna kort visar oförankrad ursprungstext. Skilj upplysning från beslut, följ röst/topic-intro och tidsförankra gammal text. |
| grind2-mecenat-samtalsvag | Portal visar åtta slutkombinationer i stället för befintlig middagsscen; fel namn | in_progress | Codex | playtest/GRIND2_NYKARRIAR_LESJOFORS_2026-09-11.md | CLAIM 2026-09-11T10:12:00+02:00 — Codex (nykarriärspåret). Verifierat 2026-09-11 mot a36d60d4 och filhistorik: EventOverlay använder MecenatDinnerEvent men EventCardInline listar getActionsForEvent; SourceSecondaryCard har hårdkodad Eklund. Återanvänd stegdialogen och avlägsna hårdkodad Eklund. Galans gestaltning bedöms separat. |
| grind2-nykarriar-kompletterande-aterprov | Separat nykarriärprov underkändes; exakt supporter-konflikt saknar täckning | in_progress | Codex | playtest/GRIND2_NYKARRIAR_LESJOFORS_2026-09-11.md | CLAIM 2026-09-11T10:12:00+02:00 — Codex (nykarriärspåret). Verifierat 2026-09-11 mot sparade checkpoint/audit och DOM: två säsonger täckta men derbyeko bröt invariant; supporter_conflict saknades. a36d60d4 rättar derbygrenen men är inte ett nytt karriärprov. Efter rättning: regressionsprov, checkpoints och styrt nytt tvåsäsongsprov; ingen pass utan faktiskt triggade riskscener. |
