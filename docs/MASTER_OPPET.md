...
|---|---|---|---|---|---|
| grind2-nykarriar-kompletterande-aterprov | Separat nykarriärprov behöver sammanhängande återprov efter derbyfixen | verifierad | Code | playtest/GRIND2_NYKARRIAR_LESJOFORS_2026-09-11.md + playtest/GRIND2_ATGARDSPASS_2026-09-11.md | ÅTERLÄMNAD 2026-09-11 efter cf2e1011. 5 137 tester och full build gröna; nio riktade checkpoint/scenkontroller täcker tidigare burnout-val, båda derbyekona och klackkonfliktens tre val i två säsongslägen med före/eftersaves och reload. Exakt supporter-konflikt har därmed riktad täckning, men inget nytt sammanhängande tvåsäsongsprov utfördes. Nästa: pinna aktuell commit och kör båda spåren (invarianter + känsla) från ny karriär. Den parallella Grind 2-passdomen står kvar som egen körning; den gör inte detta äldre nykarriärprov rent i efterhand. |
