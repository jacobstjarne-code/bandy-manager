...
|---|---|---|---|---|---|
| sasongsmal-barare-raknar-inhopp-och-ny-klubb | Målet `Låt {spelare} bära laget` är dömt som minst 15 starter, men säsongsdomen läser spelarens globala `seasonStats.gamesPlayed`; inhopp och matcher efter försäljning till en annan klubb kan därför ge ett falskt `Du gjorde det`. | in_progress | Code | DOM_EGET_SASONGSMAL_2026-08-17.md:44 + KARRIARJOURNAL_VASTANFORS_2026-09-09.md:114 | CLAIM 2026-09-11T00:47:24Z — Code. Verifierad mot kod och historik: `c025bfd7` introducerade O3-mätningen som `seasonStats.gamesPlayed >= 15`, oförändrad sedan dess, trots domens uttryckliga `startelvan i minst 15 matcher`. `seasonStats` är spelarburen över klubbbyte och skiljer inte start från bänk. Mät faktiska starter i den managerstyrda klubbens färdigspelade matcher från fixture-elvorna; räkna starter före eventuell försäljning men aldrig matcher för köparen. |
...
| id | beskrivning | status | ägare | källa | nästa-åtgärd |
|---|---|---|---|---|---|
| sluttest-grind2 | Grind 2 (andra akten: ekonomiskt val år åtta, ingen upprepad pivotal scen, färdigt anläggningsträd) ej dokumenterad som passerad | in_progress | Codex | SLUTTEST_KO.md:376 + TESTINSTRUKTION_GRIND_234_2026-09-08.md | CLAIM 2026-09-09T08:21:53+02:00 — Codex. Kör samma riktiga minst åtta säsonger långa karriär som Grind 3 och dokumentera konkreta ekonomiska val, pivotal repetition och anläggningsträd i `docs/playtest/`; Opus domar resultatet efter leverans. **LEVERANS KLAR FÖR DOM 2026-09-11:** samma save har nu tio managersäsonger, inklusive avsked, ettårigt uppehåll och ny klubb. Fullt ordinarie anläggningsträd och år-8-valet (åtta avslagna lönekrav, spelarförsäljning, sponsorer och avstådda ortsförnyelser för att rädda licensen) är dokumenterade. Upprepad pivotal scen reproducerades och dess kodfixar spåras separat. Andra akten är uttryckligen besvarad i `docs/playtest/KARRIARJOURNAL_VASTANFORS_2026-09-09.md`; detaljer i `GRIND_2_3_LANGKARRIAR_2026-09-09.md`. Testaren arkiverar inte raden; Opus domar. |
| sluttest-grind3 | Grind 3 (rytmen: primär handling, nästa olösta fråga, en landning per säsong) ej dokumenterad som passerad | in_progress | Codex | SLUTTEST_KO.md:378 + TESTINSTRUKTION_GRIND_234_2026-09-08.md | CLAIM 2026-09-09T08:21:53+02:00 — Codex. Samma långkarriär som Grind 2; för varje säsong dokumenteras primär handling, nästa olösta fråga och landningen i `docs/playtest/`. **LEVERANS KLAR FÖR DOM 2026-09-11:** primär handling, nästa olösta fråga och säsongslandning är dokumenterade genom tio managersäsonger. År 10 gav ny klubb, överlevnadsmål, cupkvartsfinal, 10:e plats och egen årsbok; omgång 13–22 snabbspolades med spelets ordinarie funktion och räknas inte som manuellt observerade beslut. Journalens rytmdom och detaljerat underlag ligger i samma två playtestfiler som Grind 2. Testaren arkiverar inte raden; Opus domar. |
| sluttest-validering-journal | Valideringsexperiment: följ-en-karriär-journalen — ej kört | in_progress | Code | SLUTTEST_KO.md:1268 + `TESTINSTRUKTION_KARRIARJOURNAL_2026-09-03.md` | CLAIM 2026-09-10T23:31:22+02:00 — Code. **LIVEUTFALL 2026-09-11:** samma riktiga save fullföljde tio managersäsonger. Efter avskedet från Västanfors efter år 9 spelades det avsedda uppehållsåret 2035/36; tränarmarknaden gav tre riktiga erbjudanden och managern tog över Skutskär. År 10, 2036/37: cupkvartsfinal, 10:e plats, 15p (6–3–13), undvek nedflyttning, ekonomi −427→−655 tkr. Full managerjournal med tio säsongsposter, mellanår, fem slutfrågor och kvitton: `docs/playtest/KARRIARJOURNAL_VASTANFORS_2026-09-09.md`. Sidofyndet `undefineds namn` kodverifierades till ett ärvt favorit-id efter klubbbytet och reparerades i samma pass: den gamla spelaren nämns bara när han finns i nya klubbens trupp; annars yttras enbart det nya, verifierade namnet. 4/4 fokustester och full build/fem grindar gröna. Exportknappen kördes efter årsboken men in-app-browsern exponerade inte hämtningen till repots filsystem; kvar före arkivering är enbart att lägga JSON-underlaget i `docs/playtest/`. Aktiv räknare fortsatt 7. |
