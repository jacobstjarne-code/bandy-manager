...
| cs-patron-sannolikhetsrullning | `PATRON_EMERGE_CS=60` är binär (100 %/0 %) — en sannolikhetsrullning måste läggas till, inte bara tröskeln bytas; empiriskt spärren för Heros | in_progress | Codex | BACKLOG.md:60, 61 + DOM_MECENAT_PATRON_MODELLFORM_2026-09-08.md | CLAIM 2026-09-09T07:27:43+02:00 — Codex. Byggs tillsammans med `mecenat-patron-modellform` som ett pass: deterministisk per-säsong-ramp, därefter domens 2000-körningars ommätning. |
...
| mecenat-patron-modellform | Per-omgångs-rullning konvergerar mot säkerhet över en karriär — kräver annan modellform (en rullning per säsong) el. mycket lägre tal | in_progress | Codex | BACKLOG.md:65 + DOM_MECENAT_PATRON_MODELLFORM_2026-09-08.md | CLAIM 2026-09-09T07:27:43+02:00 — Codex. Jacobs modellform är dömd: en seedad rullning per säsong, communityStanding-skalerad, befintligt mecenattak och avhoppslogik skyddas. Byggs i samma pass som patronrampen. |
