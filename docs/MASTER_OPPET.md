...
|---|---|---|---|---|---|
| annandagsbeat-fel-kalenderlage | Matchladdningen visar "Annandagen" för omgång 8 den 17 oktober i den importerade Grind 2-karriären. | in_progress | Codex | Grind 2, 2026-09-10 | CLAIM 2026-09-10T23:12:37+02:00 — Codex. Verifierat i aktuell kod och git: save-migrationen matchar äldre ligafixtures mot dagens kalender via global `matchday`. När den globala axeln har ändrats kan exempelvis äldre omgång 8 träffa dagens annandags-slot. Byt till fixturens stabila `roundNumber` mot `leagueRound`, med säker legacy-fallback och regression för den verkliga 17 oktober-konflikten. |
