...
| arsbok-akademi-singular | Akademiraden skriver “1 stjärnor” | verifierad | — | Grind 2-skärmbild 2026-09-11 + academyLedgerPresentationService.ts:133 + clubMemoryService.ts:335 | Två faktiska textproducenter interpolerar `${stars} stjärnor` utan böjning. Inför en delad svensk stjärnformatering och använd den i båda vägarna; regressionstesta singular och plural. |
