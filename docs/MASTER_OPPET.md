...
| rc-kontext-sprak-grafik-brett-svep | Nådda cup-, slutspels-, venue-, tids-, språk- och assetfel i tvåsäsongskörningen | in_progress | Codex | docs/playtest/GRIND2_BRETT_TVASESONGSPROV_ASTRA_27DA71B3_2026-09-11.md | CLAIM 2026-09-11T20:12:00+02:00 — Codex. Reconcile den breda rapportens konkreta repro mot aktuell kod och det parallella textpass som redan landat; verifiera cup/slutspel/venue/tid/språk/asset per faktisk konsument, bygg kvarvarande mekaniska fixar och separera uttryckligen sådant som ännu väntar Opus-text eller visuell dom. |
