...
|---|---|---|---|---|---|
| kafferum-derbyeko-saknar-cooldown | Två fasta derbyrepliker återkommer inom kafferummets tvåsäsongers cooldown | rapporterad | Code | playtest/GRIND2_NYKARRIAR_LESJOFORS_2026-09-11.md; egen UI-karriär på 5d78cc1; saves 00415→00811 och 00879→00992 | Ny avgränsad variant, inte återfall i den fixade playoff_win-grenen. derby_win och big_derby_win saknar coffeeSemanticKey/cooldown i postVictoryNarrativeService.ts; oförändrat i main17d55e4 vid avstämning. Produktens kafferumsselektor reproducerar båda replikerna från checkpoints. Verifiera enligt regel8, ge båda fasta derbygrenarna visningsidentitet/cooldown och testa även hemma/borta-formuleringen. Respektera kalibrerad matchmotor. Denna nya tvåsäsongskörning är inte grön; exakt supporter_conflict_* saknar dessutom täckning. Full rapport och 27 repro-saves länkade i källan. |
