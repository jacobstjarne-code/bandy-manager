...
| sluttest-incoming-arkivering | "Arkivera resten av `incoming/` allteftersom" — löpande, ej avslutad | in_progress | Codex | SLUTTEST_KO.md:170 | CLAIM 2026-09-09T08:16:28+02:00 — Codex. Reconcile mot `docs/incoming/README.md`, git-historiken och `_arkiv-2026-09`: den gamla radens namngivna sju Överlämning 2-underlag ser ut att vara arkiverade sedan `f8ca48ec`, med tre verkliga rester redan spårade som egna MASTER-poster. |
| sluttest-feedbackbutton-overlapp | Partiellt åtgärdat sedan fyndet — övriga skärmar orört | verifierad | Code | SLUTTEST_KO.md:173 + DOM_FEEDBACKKNAPP_PLACERING_2026-09-08.md | Byggbar, Design-gaten borttagen. Flytta den globala FeedbackButton från svävande fixed-lager till domens dockade sidfotsrad som tar verklig layoutplats; verifiera CTA-fri 390 px-yta. |
...
| sluttest-grind2 | Grind 2 (andra akten: ekonomiskt val år åtta, ingen upprepad pivotal scen, färdigt anläggningsträd) ej dokumenterad som passerad | verifierad | GPT | SLUTTEST_KO.md:376 + TESTINSTRUKTION_GRIND_234_2026-09-08.md | Väntar GPT:s långa genomspelning: minst åtta säsonger, konkreta exempel på ekonomiskt val, pivotal repetition och färdigbyggbart anläggningsträd; resultat till `docs/playtest/`. |
| sluttest-grind3 | Grind 3 (rytmen: primär handling, nästa olösta fråga, en landning per säsong) ej dokumenterad som passerad | verifierad | GPT | SLUTTEST_KO.md:378 + TESTINSTRUKTION_GRIND_234_2026-09-08.md | Väntar samma GPT-genomspelning; rapportera primär handling, nästa olösta fråga och säsongslandning per säsong i `docs/playtest/`. |
