...
| genomgang-toolchain-bump | Vite ^5.2, vitest ^1.4, @types/node 20 — två majors bakom, lock-filen måste följa | verifierad | Code | §4 | VERIFIERAD 2026-09-12 (Codex): `package.json`/lock och installerade versioner bekräftade Vite 5.4.21, Vitest 1.6.1 och @types/node 20.19.37 före ändring. Isolerad kandidat har en commit per steg, grön build och ett deterministiskt 10×5-säsongstest som är byte-identiskt före/efter bortsett från tidsstämpeln. Nästa: claima och landa de tre redan avgränsade committerna. |
