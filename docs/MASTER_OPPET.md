...
| inv-5-fas4-klubbmarken | FAS 4 (12 klubbmärken) bara 3/12 klara | in_progress | Codex · 2026-09-11T16:54:17+0200 | INVENTERING_2026-08-31.md:114 | **PILOT FORSBACKA enligt Jacob 2026-09-11:** frilägg det levererade högupplösta märket, skapa två SVG-varianter för stor/liten rendering, wira genom den befintliga ClubBadge-gränsen och browserverifiera båda storlekarna innan övriga elva tas i sekvens. Originalet bevaras. De levererade JPEG-filerna har inbakat rutmönster, alltså krävs äkta alfafriläggning före produktasset. Därefter återlämnas claimen för Jacobs visuella godkännande. |
