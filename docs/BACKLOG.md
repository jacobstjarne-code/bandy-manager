...
| # | Idé | Plats | Estimat |
|---|---|---|---|
| C-SY1 | **Synlighetssprinten** — 2 tickets kvar: orsakskrok på reaktiva texter, Portal-hierarki-justering. Efterklang V2 KLAR: header→objektnamn, tidsanvisning, tap-to-expand modal (EfterklangThreadModal) + EFTERKLANG_TYPE_ICON extraherad `8ee2e17`. Kräver designrunda per ticket före spec. | `docs/SKISS_SYNLIGHETSSPRINT_2026-05-20.md` | ~6–8h Code + 2 designrundor. |
