...
| 32 | ~~**O1** varsel-mallen, sponsorn först~~ **Sponsorn-delen KLAR (2026-08-22)** — konfliktvariant för `sponsorOffer`, text skriven och wirad. Fem återstående kandidater (kontraktet/mecenaten/anläggningen/ungdomen/supportern) obyggda |
