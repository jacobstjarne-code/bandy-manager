...
| 6.4 | Kontrastgrind, en-primär-grind, träffytegrind, matchtypsmatris-grind, datarobusthetsgrind (åtgärdslistans post 17–21) | `PÅGÅR` — post 17, 18, 20 `KLAR`, se noter nedan. Post 21 (datakort/DecisionCard/takregel) `EJ` |
