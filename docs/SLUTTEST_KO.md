...
Skärmdumpar regenererade (`screenshots/sommaren/*.png`, 390px, `capture-mode`-flaggan satt så dev-navets sticky-artefakt inte läcker in) — väntar på ny dom innan baseline-seed.
