...
| 40b | **Skutskär-auditens fixordning, punkt 1 och 3–7** (Jacobs order 2026-08-22, punkt 2/styrelsemodellen redan gjord). Se `docs/SKUTSKAR_AUDIT_FIXORDNING_2026-08-22.md` — uppdateras löpande. Punkt 1 (High 4 pressminnet, High 6 skadekortet, Medium 6 domarcitatet) KLAR. Domarcitatets loss-hink har `'[Opus]'`-platshållare, väntar text. Återstår: 3 (playoff-barriären), 4 (utmattning, rapport före kalibrering), 5 (batchstack — INTE i Jacobs lista, skippad), 6 (beslutsminne: säsongsslut+sponsordedupe+next-action), 7 (critical per instans + Form-etiketten) |
