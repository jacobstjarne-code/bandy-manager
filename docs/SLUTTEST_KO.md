...
| 6.4 | Kontrastgrind, en-primär-grind, träffytegrind, matchtypsmatris-grind, datarobusthetsgrind (åtgärdslistans post 17–21) | `PÅGÅR` — post 17 (Kontrastgrind) och 18 (en-primär) `KLAR`, se noter nedan. Post 20 (matchtypsmatris), 21 (datakort/DecisionCard/takregel) fortfarande `EJ` |
