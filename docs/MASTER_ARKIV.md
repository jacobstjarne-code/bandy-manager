...
| genomgang-save-storlek-matrad | klar | denna commit | En helt ny Västanfors-save skapad efter free-agent-fixen kördes genom tio riktiga säsongsrollovers med stressharnessets ordinarie kö-, skärm-, laguttagning- och anläggningspolicy. Mätverktyget höll bara anställningstrygghet och kassa över Game Over-gränserna för att säkra tio hela rollovers; inga samlingar rensades eller komprimerades. Kompakt UTF-8-JSON blev **1 602 986 byte (1,603 MB)** mot 7,48 MB före fixen. Saven innehöll 10 `seasonSummaries`, 375 spelare, 785 liggarposter och 137 `freeAgentIds`; legacy-`freeAgents` saknades. Största fält: `players` 776 346 byte, `eventLedger` 240 132, `narrativeBeatLog` 162 852. `freeAgentIds` tog 4 863 byte. Utfallet ligger under 2 MB-gränsen, så ingen följdspec eller ytterligare produktändring behövs. Aktiv räknare 5→4. |
