...
| grind2-nykarriar-kompletterande-aterprov | klar | `c749d279` + `86ebe78c` | Avgörande dubbelspår genomfört från riktig onboarding över två medelsvåra säsonger. Båda rolloverflödena passerade, aktiv beslutskö höll max tre, semifinal nåddes båda år och rapporten `playtest/GRIND2_BRETT_TVASESONGSPROV_ASTRA_C749D279_2026-09-11.md` ger PASS. |
| lokalhjalte-mal-hemmaplanscopy-borta | klar | `84d09beb` | Venue-bunden lokalhjältecopy ersatt med den platsneutrala ”Det kan inte bli bättre än så”; 30 seedade fall och det breda språksvepet var rena. Slutprovet nådde både hemma- och bortamatcher utan samma felmönster. |
| grind2-langtidsidentitet-tre-konsumenter | klar | `84d09beb` + `c749d279` | Tvåsäsongsprovet visade noll kafferumsnycklar inom cooldown, exakt en karriärunik gala och kanonisk tifo→konflikt utan omstart nästa säsong. Inga generiska konkurrerande supporterbeslut eller återvändande lösta event-id:n förekom. |
| rc-sasongsrollover-akademi-skada | klar | `c749d279` | Två naturliga rollover gav exakt en Målilla-kull per sommar och noll youth-id:n i seniorpopulationen; årsboken matchade 1 intagen/0 uppflyttade. Den explicita kvarvarande-skada-regressionen och övriga rolloverprov passerade 19/19 på slutkoden. |
| rc-arsbok-komplett-sanningsunderlag | klar | `c749d279` + `86ebe78c` | Två årsböcker byggde toppbetyg från fulla egna ligaunderlag (22 matcher respektive nio för en senare värvad spelare), visade sammanhängande styrelseutfall och passerade bokslutet. Transferbeslutets sista mekaniska mening språkpolerades i `86ebe78c`; 66/66 riktade tester och full build gröna. |
| rc-kontext-sprak-grafik-brett-svep | klar | `c749d279` + `86ebe78c` | 243 mobilobservationer gav noll brutna bilder och noll horisontellt spill. Passerat annandagsval pensioneras centralt, nedräknings- och årsbokstexterna är rättade och Ankomstens lästext har ett explicit ljust kontrakt på tät mörk backing. Full dom och rangordnad bildrekommendation finns i slutrapporten. |
