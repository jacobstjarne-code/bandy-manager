...
| sluttest-missing-check-grind | klar | `14dcaf22`/`01f7d3bd`/`96aa74f6`/`f9527653`/`6987cac4`/`f04ef583`/`d3724e63` | SLUTTEST_KO.md:231,265 + DOM_PASTAENDE_GENERERINGSKONTRAKT_2026-09-08.md — ett gemensamt ProofSource-kontrakt används nu av 18 liggarvymallar, hela releasepopulationen i events/* (41 granskade GameEvent-konstruktioner plus eventResolver-nollgräns) och pressens verkliga registerpopulation (29 taggar: 24 state-predikat, 5 explicita tidlösa routingfall). Samma predikat som väljer ett pressvar producerar dess bevis; inga parallella villkor. Kontraktet fångade och rättade sponsor_positive-feltexten, patronkö-fallet Ingen patron, ogiltiga sponsorvillkor och kaptensproxyfelet. Press: 170/170 fokustester, TypeScript och full build med fyra lintgrindar gröna. Lägre risksystem förblir uttryckligen POST-LAUNCH enligt domen |
