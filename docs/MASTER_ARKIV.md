...
| sluttest-feedbackbutton-overlapp | klar | `23be2b6d` | `DOM_FEEDBACKKNAPP_PLACERING_2026-09-08.md` — den globala feedbackknappen flyttad från svävande overlay till en dockad sidfotsrad i GameShell, med egen reserverad layouthöjd ovanför BottomNav. Match/review och chrome-fria ceremonier behåller avsiktlig döljning. Browser verifierade dashboard, trupp och match i riktig 390 px-karriär; 3 nya regressionsprov, TypeScript, full svit 4 921/4 921 och produktionsbyggets fyra grindar gröna. |
