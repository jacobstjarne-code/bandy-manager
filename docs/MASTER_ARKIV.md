...
|---|---|---|---|
| tranarmarknad-ny-klubb-andra-aret | klar | `e7eeedd7`, `829e7a56` | 2026-09-10: tillstånd N väljs vid första mötet efter klubbyte, skriver manager_appointed och använder Opus låsta pool. Den dynamiska övertaganderaden läser både aktuell manager_appointed-post och clubSpells; avsked/frivilligt/återkomst täcks, saknat belägg ger ingen text. 16 fokustester, TypeScript och full build/fem grindar gröna. Browser 390 px: N-ton, ”Du kom hit efter att Bollnäs GoIF tackat för sig.”, ekonomi/mål och exakt en CTA-pil. docs/playtest/NY_KLUBB_STYRELSEMOTE_2026-09-10.md. |
