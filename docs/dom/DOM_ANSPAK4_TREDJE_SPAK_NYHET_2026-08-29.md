...
**Datum:** 2026-08-29 · **Av:** Opus · **Beslut:** Jacob (väg A — bygg en verklig kostnad; ramen "ett topplag måste hela tiden hitta på nytt, annars blir supportrarna uttråkade"). Utökar `docs/dom/DOM_ANSPAK4_ORTSUNDERHALL_2026-08-29.md` med den spak de två godkända knapparna saknade.
