...
**Datum:** 2026-08-17 · **Av:** Opus · **Post:** O1 i `docs/archive/historiska-statuskallor/SLUTTEST_KO.md`
...
**Det som kan göras före Grind 1** och som inte kräver ny mekanik: klassificera alla befintliga händelser mot mallens fem punkter. Hur många uppfyller fem? Fyra? Två? Det talet är utgångsläget. Ligger som Code-rapport i `docs/archive/historiska-statuskallor/SLUTTEST_KO.md`.
