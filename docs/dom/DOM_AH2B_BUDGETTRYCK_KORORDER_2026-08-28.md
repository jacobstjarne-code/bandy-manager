# ⛔ ERSATT AV `docs/dom/DOM_AH2B_RETENTION_2026-08-28.md` — BYGG INTE PÅ DENNA

**Upptäckt i 2026-08-31-inventeringen:** denna dom saknade en supersede-pekare
trots att `docs/dom/DOM_AH2B_RETENTION_2026-08-28.md` (skriven samma dag) uttryckligen
...
**Grund:** `docs/dom/DOM_FRAMGANGSKURVAN_2026-08-27.md`, anspåk 1 ("Truppen vill ha det den är värd — du kan inte betala alla").
