...
**Grund:** `docs/dom/DOM_FRAMGANGSKURVAN_2026-08-27.md` (H3), `HIGH2_UTMATTNINGEN_FORSLAG_2026-08-22.md`, samt kodläsning `matchInjuryService.ts`, `squadEvaluator.ts:41`, `setLineup.ts`.
