...
**Ersätter:** hela budgettrycks-ansatsen i `docs/dom/DOM_AH2B_BUDGETTRYCK_KORORDER_2026-08-28.md`. Den körordern är därmed avslutad; dess STEG 1-DOM (wageBudget rådgivande) står kvar som fynd men dess metrik är övergiven.
**Grund:** `docs/dom/DOM_FRAMGANGSKURVAN_2026-08-27.md` anspåk 1 + 2. Fem mätpass: `anspark1-condition2-*`, `anspark1-villkor-omdesign-*`, `anspark1-budgettryck-ekonomi-matning-2026-08-28.ts`.
...
kodläst fynd (docs/archive/historiska-statuskallor/SLUTTEST_KO.md A-H2b-raden, 2026-08-28) upptäckte: mittenlag
...
Dörr a/b orörda. docs/archive/historiska-statuskallor/SLUTTEST_KO.md A-H2b "dörr (c)"-fyndet är nu åtgärdat, inte
bara rapporterat.
