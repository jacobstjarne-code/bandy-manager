# ⛔ ERSATT AV `docs/dom/DOM_FRAMGANGSKURVAN_2026-08-27.md` — BYGG INTE PÅ DENNA

**Upptäckt i 2026-08-31-inventeringen:** denna dom saknade en supersede-pekare
trots att `docs/dom/DOM_FRAMGANGSKURVAN_2026-08-27.md` uttryckligen ersätter dess hela
...
inom anspråk-strukturen — läs `docs/dom/DOM_FRAMGANGSKURVAN_2026-08-27.md` först.
