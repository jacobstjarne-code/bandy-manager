...
**2026-08-25.** Beställt som fråga 2 och 4 i `docs/dom/DOM_FORUTSATTNINGSFASEN_2026-08-24.md`s rapportkrav, körd som bakgrundsutredning parallellt med H4 Heros-uppföljningen. **OBS:** Jacobs efterföljande order samma dag ("Bygg inte en ny förutsättningsfas... Bygg ut generatePreSeasonMessage") gör att del B nedan (var fasen hör hemma) för närvarande är referens, inte en aktiv spec — men fyndet om `generatePreSeasonMessage` som befintligt prejudikat blev direkt relevant för den byggda H4-uppföljningen (se `docs/archive/historiska-statuskallor/BACKLOG.md`).
