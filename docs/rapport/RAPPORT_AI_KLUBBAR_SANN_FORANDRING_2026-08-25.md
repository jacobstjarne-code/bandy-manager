...
**2026-08-25.** Byggd ovanpå `docs/rapport/RAPPORT_LIGARORELSER_ELVA_KLUBBAR_2026-08-25.md` (läst och omverifierad, inte bara tagen på förtroende — en omverifiering avslöjade en bugg den ursprungliga rapporten inte flaggade, se §2). Fråga: inte "vad finns", utan "vad skulle KRÄVAS" — en konstruktiv genomförbarhetsanalys, ingen UI/feature-design, inget byggt.
