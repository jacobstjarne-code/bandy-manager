...
| 8 Delad rate limit bakom Vercel | **Avgjort 2026-09-25:** spelet anropar Render direkt, så `trust proxy 1` ger klientens IP. Värdet 2 hade öppnat för förfalskad hink. Se `RAPPORT_SAKERHET_2026-09-25.md`. | `server.js` (kommentar) |
...
Kvar: fynd 1 (Postgres-flytt före 2026-10-10), fynd 10 (MASTER_OPPET-raderna
