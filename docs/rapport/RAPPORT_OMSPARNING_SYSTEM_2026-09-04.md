...
**Datum:** 2026-09-04 · **Av:** Opus · **Föregångare:** `docs/rapport/RAPPORT_LIGGARE_KONSUMENTKARTA_2026-09-03.md` (per typ). Den här är **per system**: skriver systemet till liggaren, minns det (steg 2: återfall/årsdag/told), talar det (steg 3: vilka ytor), och går det genom Berättaren eller vid sidan av?
...
Leverera `docs/rapport/RAPPORT_OMSPARNING_RAW_2026-09-04.md`, inga kodändringar, inga domar:
