...
**Det här är i praktiken IDENTISKT med mätningen jag gjorde före kaskadborttagningen.** Att ta bort licenseReview-kaskaden (3 spelare, −15 rykte, 60% sponsorer) ändrade INTE den underliggande nettoresultat-fördelningen mätbart. Det betyder att min rapport igår (`docs/rapport/RAPPORT_ATERKOPPLINGSSLINGAN_HITTAD_2026-08-26.md`), som pekade ut den kaskaden som förklaringen till 100x-avvikelsen, var **fel eller kraftigt ofullständig** — kaskaden var en verklig, självförstärkande mekanism värd att ta bort på egna meriter (spelaren ska välja, inte systemet), men den var inte den dominerande orsaken till KLIPPAN specifikt.
