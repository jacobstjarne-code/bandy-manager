...
`SeasonSummaryScreen.tsx` anropar den nu istf den gamla 3-grenade texten. docs/archive/historiska-statuskallor/BACKLOG.md flaggat (TVÅ LÄSARE-tabellen) med din motivering, så ingen slår ihop axlarna av misstag senare.
