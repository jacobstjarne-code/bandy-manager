...
**Arkiverat 2026-09-10, erfarenpasset:** `sen1.jpeg`–`sen30.jpeg` har bevarats som `portrait_exp_1.jpeg`–`portrait_exp_30.jpeg` i samma originalarkiv. Produktversionerna är frilagda och komprimerade 400×400 PNG-filer i `public/assets/portraits/`, och erfaren-poolen väljer nu deterministiskt ur samtliga 30 godkända porträtt.
