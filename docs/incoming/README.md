...
`Överlämning 2/`s sju obekräftade poster är känd skuld — vänta med dem tills sluttestkön är klar. Mappen är annars tom på "status okänd"-poster efter 2026-09-01-städningen.
