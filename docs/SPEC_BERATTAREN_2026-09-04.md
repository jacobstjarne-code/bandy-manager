...
Steg 1–6 är byggda och lokalt verifierade. Efterklang använder agendan för de historiska källor som har säker kanon, skriver `surface: efterklang`-kvitto och behåller bara de live-/cachekällor och legacyfallbackar som §5 uttryckligen kräver under stranglern. Nästa kodsteg är 7, pressens liggarfråga. Inför steg 9 är producentinventeringen klar; Opus återfallsvarianter/skip-dom återstår innan Code kan ändra spelartextens semantik.
