...
Det omfattar också licensens befintliga ryktesskala och meritbufferten. Ryktesskalan (−5 vid underskottsbaslinjen, ytterligare −5 per 50 000 kr och tak −30) och `MERIT_BUFFER_CAP=20` ingick båda i A-kedjan som skulle bli dom i rundan; baslinjen nådde stoppvillkoret utan parameterändring och värdena behålls därför. Ryktesskalan är namngiven och exakt testlåst i `licenseService.ts`; meritbuffertens intjäning, tak och förbrukning är testlåsta i `boardService.test.ts`.
