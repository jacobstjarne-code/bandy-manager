...
**Status:** Spec-klar. **Bygger på beat-primitiven** (`docs/spec/SPEC_BEAT_PRIMITIV_2026-06-22.md`) — bygg den först. Callback är primitivens första konsument: en familj moment-ankrade minnes-beats, severity 0–1, som rider `firesBeforeNextFixture`.
