...
export const SCENES: [string, string?, string?, boolean?, number?][] = [
  ...
  // GameOverScreen är position:fixed och har en egen overflow-scroller.
  // Element-stitching av dev-wrappern fotograferar därför ett godtyckligt
  // scrollsegment av overlayn; använd samma helsideväg som övriga fixed overlays.
  ['game-over', undefined, undefined, true, 844], ['game-over-historik'],
